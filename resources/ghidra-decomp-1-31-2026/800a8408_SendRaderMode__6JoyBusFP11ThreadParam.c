// Function: SendRaderMode__6JoyBusFP11ThreadParam
// Entry: 800a8408
// Size: 268 bytes

undefined4 SendRaderMode__6JoyBusFP11ThreadParam(JoyBus *joyBus,ThreadParam *threadParam)

{
  ...
  uVar2 = GetRadarMode__8GbaQueueFi(&GbaQue,threadParam->m_portIndex);
  local_18 = (uint)CONCAT21(0x140e,uVar2) << 8;
