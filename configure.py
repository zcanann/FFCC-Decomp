...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "p_map.cpp", extra_cflags=["-pooldata off", "-RTTI on", "-sdata 8", "-inline auto,deferred", "-str reuse,pool,readonly", "-Cpp_exceptions off"]),
            ...
            Object(NonMatching, "p_minigame.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-common off", "-str reuse,pool,readonly"]),
