// Function: pppRenderLaser
// Entry: 801754e0
// Size: 3008 bytes

/* WARNING: Removing unreachable block (ram,0x80176084) */
/* WARNING: Removing unreachable block (ram,0x8017607c) */
/* WARNING: Removing unreachable block (ram,0x80176074) */
/* WARNING: Removing unreachable block (ram,0x80175500) */
/* WARNING: Removing unreachable block (ram,0x801754f8) */
/* WARNING: Removing unreachable block (ram,0x801754f0) */
/* WARNING: Struct "CGBaseObj": ignoring overlapping field "vtable" */

void pppRenderLaser(pppLaser *pppLaser,UnkB *param_2,UnkC *param_3)

{
  ...
  pfVar13 = (float *)((int)(&pppLaser->field0_0x0 + 2) + param_3->m_serializedDataOffsets[2]);
  if (param_2->m_dataValIndex != 0xffff) {
    ...
    pppSetDrawEnv__FP10pppCVECTORP10pppFMATRIXfUcUcUcUcUcUcUc
              (FLOAT_80333428,(pppCVector *)(&pppLaser->field_0x88 + iVar5),
               &(pppLaser->field0_0x0).m_localMatrix,param_2->m_payload[0x39],
    ...
    local_2d4 = *(undefined4 *)(&pppLaser->field_0x88 + iVar5);
    ...
    local_24c.value[0][0] = (pppLaser->field0_0x0).m_localMatrix.value[0][0];
    local_24c.value[0][1] = (pppLaser->field0_0x0).m_localMatrix.value[0][1];
    local_24c.value[0][2] = (pppLaser->field0_0x0).m_localMatrix.value[0][2];
    local_24c.value[0][3] = (pppLaser->field0_0x0).m_localMatrix.value[0][3];
    local_24c.value[1][0] = (pppLaser->field0_0x0).m_localMatrix.value[1][0];
    local_24c.value[1][1] = (pppLaser->field0_0x0).m_localMatrix.value[1][1];
    local_24c.value[1][2] = (pppLaser->field0_0x0).m_localMatrix.value[1][2];
    local_24c.value[1][3] = (pppLaser->field0_0x0).m_localMatrix.value[1][3];
    local_24c.value[2][0] = (pppLaser->field0_0x0).m_localMatrix.value[2][0];
    local_24c.value[2][1] = (pppLaser->field0_0x0).m_localMatrix.value[2][1];
    local_24c.value[2][2] = (pppLaser->field0_0x0).m_localMatrix.value[2][2];
    local_24c.value[2][3] = (pppLaser->field0_0x0).m_localMatrix.value[2][3];
    ...
    if (param_2->m_stepValue != 9.18341e-41) {
      ...
      local_98 = 0x43300000;
      dVar14 = (double)(FLOAT_8033342c /
                       (float)((double)CONCAT44(0x43300000,uStack_94) - DOUBLE_80333438));
      ...
      if ((CFlat._4764_4_ & 0x200000) != 0) {
        ...
        if ((CFlat._4764_4_ & 0x200000) != 0) {
          ...
          local_2d0.x = FLOAT_80333428;
          local_2d0.y = FLOAT_80333428;
          local_2d0.z = FLOAT_8033342c;
          ...
          PSMTXConcat(&(pppLaser->field0_0x0).m_localMatrix,&local_188,&local_188);
        ...
        GXLoadPosMtxImm(&pppLaser->field_0x40,0);
        dVar14 = (double)FLOAT_80333428;
        iVar5 = 0;
        local_2d4 = 0xffffffff;
        for (iVar6 = 0; iVar6 < (int)(uint)param_2->m_payload[0x1e]; iVar6 = iVar6 + 1) {
          ...
          if ((((double)*pfVar8 != dVar14) || ((double)pfVar8[1] != dVar14)) ||
            ...
            PSMTXScale(FLOAT_80333430,FLOAT_80333430,FLOAT_80333430,&MStack_1bc);
            fVar10 = pfVar13[7];
