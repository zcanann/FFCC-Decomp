...
unsigned int initData__6CMcPcs[9] = {
    0,
    0xFFFFFFFF,
...
struct CMcPcsInitializer {
    ...
    {
        McPcs = __vt__6CMcPcs;
        m_table__6CMcPcs[1] = initData__6CMcPcs[0];
        m_table__6CMcPcs[2] = initData__6CMcPcs[1];
        m_table__6CMcPcs[3] = initData__6CMcPcs[2];
        m_table__6CMcPcs[4] = initData__6CMcPcs[3];
        m_table__6CMcPcs[5] = initData__6CMcPcs[4];
        m_table__6CMcPcs[6] = initData__6CMcPcs[5];
        m_table__6CMcPcs[7] = initData__6CMcPcs[6];
        m_table__6CMcPcs[8] = initData__6CMcPcs[7];
        m_table__6CMcPcs[9] = initData__6CMcPcs[8];
    }
};
