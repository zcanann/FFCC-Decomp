 ...
 * JP Size: TODO
 */
extern "C" asm void skin__Q26CChara5CMeshFiiiPQ26CChara5CSkinPvPvPvP6S16VecP6S16VecP6S16VecP6S16Vec(
    int meshIndex, int start, int count, CChara::CSkin* skinRef,
    void* srcPos, void* srcNrm, void* srcWgt, S16Vec* dstPos,
    S16Vec* dstNrm, S16Vec* dstTan, S16Vec* dstBinorm)
{
    nofralloc
    stwu r1, -0x150(r1)
    stfd f31, 0x140(r1)
