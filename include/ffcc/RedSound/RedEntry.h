...
enum RedEntryBankLayoutSize {
	...
	REDSOUND_HISTORY_BANK_ID_OFFSET = 0,
	REDSOUND_HISTORY_BANK_HISTORY_NO_OFFSET = REDSOUND_HISTORY_BANK_ID_OFFSET + sizeof(int),
	REDSOUND_HISTORY_BANK_DATA_OFFSET = REDSOUND_HISTORY_BANK_HISTORY_NO_OFFSET + sizeof(int),
	REDSOUND_HISTORY_BANK_SIZE_OFFSET = REDSOUND_HISTORY_BANK_DATA_OFFSET + sizeof(int),
...
enum RedMusicTrackBlockLayout {
	...
	REDSOUND_MUSIC_TRACK_BLOCK_SIZE_HI0_OFFSET =
	    REDSOUND_MUSIC_TRACK_BLOCK_SIZE_LO_OFFSET + sizeof(unsigned char),
	REDSOUND_MUSIC_TRACK_BLOCK_SIZE_HI1_OFFSET =
	    REDSOUND_MUSIC_TRACK_BLOCK_SIZE_HI0_OFFSET + sizeof(unsigned char),
	REDSOUND_MUSIC_TRACK_BLOCK_SIZE_HI2_OFFSET =
	    REDSOUND_MUSIC_TRACK_BLOCK_SIZE_HI1_OFFSET + sizeof(unsigned char),
	REDSOUND_MUSIC_TRACK_BLOCK_COMMAND_OFFSET =
	    REDSOUND_MUSIC_TRACK_BLOCK_SIZE_HI2_OFFSET + sizeof(unsigned char),
...
enum RedMusicHeaderFlag {
	...
	REDSOUND_MUSIC_HEADER_SIGNATURE_OFFSET = 0,
	REDSOUND_MUSIC_HEADER_MUSIC_NO_OFFSET = REDSOUND_MUSIC_HEADER_SIGNATURE_OFFSET + REDSOUND_MUSIC_SIGNATURE_SIZE,
	REDSOUND_MUSIC_HEADER_WAVE_NO_OFFSET = REDSOUND_MUSIC_HEADER_MUSIC_NO_OFFSET + sizeof(short),
	REDSOUND_MUSIC_HEADER_TRACK_COUNT_OFFSET = REDSOUND_MUSIC_HEADER_WAVE_NO_OFFSET + sizeof(short),
	REDSOUND_MUSIC_HEADER_REVERB_KIND_OFFSET = REDSOUND_MUSIC_HEADER_TRACK_COUNT_OFFSET + sizeof(char),
	REDSOUND_MUSIC_HEADER_REVERB_DEPTH_OFFSET = REDSOUND_MUSIC_HEADER_REVERB_KIND_OFFSET + sizeof(char),
	REDSOUND_MUSIC_HEADER_FLAGS_OFFSET = REDSOUND_MUSIC_HEADER_REVERB_DEPTH_OFFSET + sizeof(short),
	REDSOUND_MUSIC_HEADER_RESERVED0E_OFFSET = REDSOUND_MUSIC_HEADER_FLAGS_OFFSET + sizeof(short),
	REDSOUND_MUSIC_HEADER_DATA_SIZE_OFFSET =
	    REDSOUND_MUSIC_HEADER_RESERVED0E_OFFSET + sizeof(unsigned short),
	REDSOUND_MUSIC_HEADER_PLAY_FLAGS_OFFSET = REDSOUND_MUSIC_HEADER_DATA_SIZE_OFFSET + sizeof(int),
	REDSOUND_MUSIC_HEADER_RESERVED18_OFFSET =
	    REDSOUND_MUSIC_HEADER_PLAY_FLAGS_OFFSET + sizeof(unsigned int),
	REDSOUND_MUSIC_HEADER_RESERVED1C_OFFSET = REDSOUND_MUSIC_HEADER_RESERVED18_OFFSET + sizeof(int),
...
enum RedSeSepHeadLayout {
	...
	REDSOUND_SESEP_SIGNATURE_OFFSET = 0,
	REDSOUND_SESEP_SE_NO_OFFSET = REDSOUND_SESEP_SIGNATURE_OFFSET + REDSOUND_SESEP_SIGNATURE_SIZE,
	REDSOUND_SESEP_SIZE_AND_FLAGS_OFFSET = REDSOUND_SESEP_SE_NO_OFFSET + sizeof(int),
	REDSOUND_SESEP_INFO_OFFSET = REDSOUND_SESEP_SIZE_AND_FLAGS_OFFSET + sizeof(unsigned int),
	REDSOUND_SESEP_HEADER_SIZE = REDSOUND_SESEP_INFO_OFFSET,
	REDSOUND_SESEP_WAVE_NO_LO_OFFSET = REDSOUND_SESEP_INFO_OFFSET + sizeof(unsigned char),
	REDSOUND_SESEP_WAVE_NO_HI_OFFSET = REDSOUND_SESEP_WAVE_NO_LO_OFFSET + sizeof(unsigned char),
	REDSOUND_SESEP_RESERVED13_OFFSET = REDSOUND_SESEP_WAVE_NO_HI_OFFSET + sizeof(unsigned char),
...
enum RedSeInfoSequenceLayout {
	...
	REDSOUND_SE_INFO_SEQUENCE_OFFSET_HI_AND_FLAGS_OFFSET =
	    REDSOUND_SE_INFO_SEQUENCE_OFFSET_LO_OFFSET + sizeof(unsigned char),
};
...
enum RedSeInfoLayout {
	...
	REDSOUND_SE_INFO_WAVE_NO_LO_OFFSET = REDSOUND_SE_INFO_FLAGS_AND_COUNT_OFFSET + sizeof(unsigned char),
	REDSOUND_SE_INFO_WAVE_NO_HI_OFFSET = REDSOUND_SE_INFO_WAVE_NO_LO_OFFSET + sizeof(unsigned char),
	REDSOUND_SE_INFO_ERASE_TRACK_OFFSET = REDSOUND_SE_INFO_WAVE_NO_HI_OFFSET + sizeof(unsigned char),
	REDSOUND_SE_INFO_ATTR_MASK_OFFSET = REDSOUND_SE_INFO_ERASE_TRACK_OFFSET + sizeof(unsigned char),
	REDSOUND_SE_INFO_SEQUENCE_OFFSET = REDSOUND_SE_INFO_ATTR_MASK_OFFSET + sizeof(unsigned char),
...
enum RedSeBlockEntryLayout {
	...
	REDSOUND_SE_BLOCK_SIGNATURE_OFFSET = 0,
	REDSOUND_SE_BLOCK_RESERVED08_OFFSET = REDSOUND_SE_BLOCK_SIGNATURE_OFFSET + REDSOUND_SE_BLOCK_SIGNATURE_SIZE,
	REDSOUND_SE_BLOCK_SE_COUNT_OFFSET = REDSOUND_SE_BLOCK_RESERVED08_OFFSET + REDSOUND_SE_BLOCK_RESERVED08_SIZE,
	REDSOUND_SE_BLOCK_SIZE_OFFSET = REDSOUND_SE_BLOCK_SE_COUNT_OFFSET + sizeof(short),
	REDSOUND_SE_BLOCK_ENTRIES_OFFSET = REDSOUND_SE_BLOCK_SIZE_OFFSET + sizeof(int),
...
enum RedWaveHeadLayout {
	...
	REDSOUND_WAVE_HEAD_SIGNATURE_OFFSET = 0,
	REDSOUND_WAVE_HEAD_WAVE_NO_OFFSET = REDSOUND_WAVE_HEAD_SIGNATURE_OFFSET + REDSOUND_WAVE_SIGNATURE_SIZE,
	REDSOUND_WAVE_HEAD_WAVE_SIZE_OFFSET = REDSOUND_WAVE_HEAD_WAVE_NO_OFFSET + sizeof(short),
	REDSOUND_WAVE_HEAD_TABLE_COUNT_OFFSET = REDSOUND_WAVE_HEAD_WAVE_SIZE_OFFSET + sizeof(int),
	REDSOUND_WAVE_HEAD_TONE_COUNT_OFFSET = REDSOUND_WAVE_HEAD_TABLE_COUNT_OFFSET + sizeof(int),
	REDSOUND_WAVE_HEAD_ARAM_ADDRESS_OFFSET = REDSOUND_WAVE_HEAD_TONE_COUNT_OFFSET + sizeof(int),
	REDSOUND_WAVE_HEAD_LOAD_SIZE_OFFSET = REDSOUND_WAVE_HEAD_ARAM_ADDRESS_OFFSET + sizeof(int),
	REDSOUND_WAVE_HEAD_RESERVED18_OFFSET = REDSOUND_WAVE_HEAD_LOAD_SIZE_OFFSET + sizeof(int),
