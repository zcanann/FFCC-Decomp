// Function: CheckHitCylinder__7CMapObjFP12CMapCylinderP3VecUl
// Entry: 80028bc0
// Size: 736 bytes

undefined4
CheckHitCylinder__7CMapObjFP12CMapCylinderP3VecUl
          (int param_1,Vec *param_2,Vec *param_3,uint param_4)

{
  ...
  if (((*(char *)(param_1 + 0x1d) == '\x02') && (*(int *)(param_1 + 0xc) != 0)) &&
    ...
    if (bVar2) {
      ...
      iVar5 = CheckHitCylinder__7CMapHitFP12CMapCylinderP3VecUl
