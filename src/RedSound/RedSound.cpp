...
enum RedSoundLocalSize {
	...
	REDSOUND_STREAM_BANK_ID_OFFSET = 0,
	REDSOUND_STREAM_BANK_DATA_OFFSET = REDSOUND_STREAM_BANK_ID_OFFSET + sizeof(int),
	REDSOUND_STREAM_BANK_FILE_SIZE_OFFSET = REDSOUND_STREAM_BANK_DATA_OFFSET + sizeof(RedStreamFile*),
	REDSOUND_STREAM_BANK_READ_POINT_OFFSET = REDSOUND_STREAM_BANK_FILE_SIZE_OFFSET + sizeof(int),
	REDSOUND_STREAM_BANK_PLAY_POINT_OFFSET = REDSOUND_STREAM_BANK_READ_POINT_OFFSET + sizeof(int),
	REDSOUND_STREAM_BANK_RESERVED14_OFFSET = REDSOUND_STREAM_BANK_PLAY_POINT_OFFSET + sizeof(int),
	REDSOUND_STREAM_BANK_RESERVED14_SIZE = sizeof(int),
	REDSOUND_STREAM_BANK_RESERVED18_OFFSET =
	    REDSOUND_STREAM_BANK_RESERVED14_OFFSET + REDSOUND_STREAM_BANK_RESERVED14_SIZE,
...
enum RedSoundSmallDataLayout {
	REDSOUND_SOUND_SBSS_DRIVER_OFFSET = 0,
	...
	REDSOUND_SOUND_SBSS_AUTO_ID_OFFSET =
	    REDSOUND_SOUND_SBSS_DRIVER_OFFSET + REDSOUND_DRIVER_OBJECT_SIZE + REDSOUND_SBSS_PADDING_SIZE,
	REDSOUND_SOUND_SBSS_STREAM_BANK_OFFSET =
	    REDSOUND_SOUND_SBSS_AUTO_ID_OFFSET + REDSOUND_AUTO_ID_SIZE,
	REDSOUND_SBSS_SIZE = REDSOUND_SOUND_SBSS_STREAM_BANK_OFFSET + REDSOUND_STREAM_BANK_PTR_SIZE,
};
