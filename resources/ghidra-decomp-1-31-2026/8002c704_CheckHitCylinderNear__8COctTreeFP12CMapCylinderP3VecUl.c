// Function: CheckHitCylinderNear__8COctTreeFP12CMapCylinderP3VecUl
// Entry: 8002c704
// Size: 420 bytes

void CheckHitCylinderNear__8COctTreeFP12CMapCylinderP3VecUl
...

{
  ...
  if ((*(char *)&octTree->vtable == '\x02') && (*(int *)((int)octTree->field2_0x8 + 0xc) != 0)) {
    ...
    CheckHitCylinderNear_r__8COctTreeFP8COctNode(octTree,octTree->rootNode);
  }
  return;
}
