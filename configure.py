...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "materialman.cpp", extra_cflags=["-inline auto,deferred"]),
            ...
            Object(NonMatching, "p_dbgmenu.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-inline auto,deferred"]),
            ...
            Object(NonMatching, "p_graphic.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_light.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-inline auto,deferred", "-str reuse,pool,readonly"]),
            Object(NonMatching, "p_map.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-inline auto,deferred"]),
            Object(NonMatching, "p_MaterialEditor.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_mc.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_menu.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_minigame.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-common off"]),
