// Function: CacheLoadTexture__12CMaterialSetFiP13CAmemCacheSet
// Entry: 8003c7a0
// Size: 132 bytes

void CacheLoadTexture__12CMaterialSetFiP13CAmemCacheSet
  ...
  if (iVar1 != 0) {
    ...
    for (iVar3 = 0; iVar3 < (int)(uint)*(ushort *)(iVar1 + 0x18); iVar3 = iVar3 + 1) {
      if (*(CTexture **)(iVar2 + 0x3c) != (CTexture *)0x0) {
        CacheLoadTexture__8CTextureFP13CAmemCacheSet(*(CTexture **)(iVar2 + 0x3c),amemCacheSet);
      }
      iVar2 = iVar2 + 4;
    }
  }
