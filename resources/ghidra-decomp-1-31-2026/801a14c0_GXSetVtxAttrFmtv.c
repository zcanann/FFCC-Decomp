...

{
  ...
  for (; iVar2 = DAT_80333828, *param_2 != 0xff; param_2 = param_2 + 4) {
  ...
  *(uint *)(DAT_80333828 + 0x4f4) = *(uint *)(DAT_80333828 + 0x4f4) | 0x10;
  *(byte *)(iVar2 + 0x4f3) = *(byte *)(iVar2 + 0x4f3) | (byte)(1 << (param_1 & 0xff));
  return;
}
