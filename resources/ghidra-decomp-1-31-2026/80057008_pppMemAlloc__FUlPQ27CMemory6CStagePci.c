// Function: pppMemAlloc__FUlPQ27CMemory6CStagePci
// Entry: 80057008
// Size: 780 bytes

/* WARNING: Struct "CGBaseObj": ignoring overlapping field "vtable" */

int pppMemAlloc__FUlPQ27CMemory6CStagePci
              (undefined4 param_1,CStage *stage,char *param_3,int param_4)

{
  ...
  DAT_8032ed64 = 0;
  do {
    iVar6 = _Alloc__7CMemoryFUlPQ27CMemory6CStagePcii(&Memory,param_1,stage,param_3,param_4,1);
    if (iVar6 != 0) {
      return iVar6;
    }
    if (bVar2) {
    ...
    do {
      if ((((*pcVar11 == '\0') && (pCVar12->m_pppMngStArr[0].m_baseTime != -0x1000)) &&
        ...
        if (bVar10 < bVar1) {
          ...
          unaff_r25 = (uint)pCVar12->m_pppMngStArr[0].m_prioTime;
          bVar10 = bVar1;
        }
        else if ((bVar10 == bVar1) &&
                (uVar5 = (uint)pCVar12->m_pppMngStArr[0].m_prioTime, (int)unaff_r25 < (int)uVar5)) {
          p_Var7 = pCVar12->m_pppMngStArr;
          unaff_r25 = uVar5;
        }
      }
      if (((pcVar11[1] == '\0') && (pCVar12->m_pppMngStArr[1].m_baseTime != -0x1000)) &&
        ...
        if (bVar10 < bVar1) {
          ...
          unaff_r25 = (uint)pCVar12->m_pppMngStArr[1].m_prioTime;
          bVar10 = bVar1;
        }
        else if ((bVar10 == bVar1) &&
                (uVar5 = (uint)pCVar12->m_pppMngStArr[1].m_prioTime, (int)unaff_r25 < (int)uVar5)) {
          p_Var7 = pCVar12->m_pppMngStArr + 1;
          unaff_r25 = uVar5;
        }
      }
