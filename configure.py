...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "p_gba.cpp", cflags=[*cflags_game_cpp_exceptions, "-RTTI on", "-sdata 8", "-str reuse,pool,readonly"]),
            ...
            Object(NonMatching, "p_map.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-inline auto,deferred", "-str reuse,pool,readonly", "-Cpp_exceptions off"]),
