// Function: EraseDat__6McCtrlFv
// Entry: 800e6b98
// Size: 2200 bytes

int EraseDat__6McCtrlFv(McCtrl *mcCtrl)
  ...
  case 0x11:
    ...
    if (cVar3 == '\x01') {
      ...
      if (mcCtrl->m_lastResult < 0) {
        ...
        SetListDat__6McCtrlFii(mcCtrl,mcCtrl->m_iteration + -1,1);
        BindMcObj__8CMenuPcsFi(&MenuPcs,mcCtrl->m_iteration + -1);
