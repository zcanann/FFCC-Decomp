...
void CPartPcs::createLoad()
{
    ...
    char* chobitPath = stringBase + 0x24C;
    ...
    pppLoadPtx__8CPartMngFPCciiPvi(&PartMng, chobitPath, 1, 1, 0, 0);
    pppLoadPmd__8CPartMngFPCc(&PartMng, chobitPath);
    pppLoadPan__8CPartMngFPCc(&PartMng, chobitPath);
