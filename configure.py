...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "mapanim.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly"]),
            ...
            Object(NonMatching, "p_light.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_map.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            ...
            Object(NonMatching, "p_minigame.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_sample.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_sound.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_system.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
            Object(NonMatching, "p_tina.cpp", extra_cflags=["-RTTI on", "-sdata 8"]),
