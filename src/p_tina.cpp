...
void CPartPcs::createLoad()
{
    ...
    char* chobitName = stringBase + 0x24C;
    ...
    pppLoadPtx__8CPartMngFPCciiPvi(&PartMng, chobitName, 1, 1, 0, 0);
    pppLoadPmd__8CPartMngFPCc(&PartMng, chobitName);
    pppLoadPan__8CPartMngFPCc(&PartMng, chobitName);
