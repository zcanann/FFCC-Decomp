// Function: HandleReverbDpl2
// Entry: 801970dc
// Size: 1292 bytes

void HandleReverbDpl2(uint *param_1,int param_2,int param_3)

{
  ...
  dVar20 = DAT_80333818;
  fVar19 = DAT_8033380c;
  fVar3 = *(float *)(param_2 + 0x1e0);
  fVar4 = *(float *)(param_2 + 0x228);
  fVar16 = *(float *)(param_2 + 0x224) * DAT_80333810;
  fVar17 = DAT_80333810 - fVar16;
  piVar43 = (int *)(param_2 + 0xf0 + param_3 * 0x3c);
  piVar41 = (int *)(param_2 + param_3 * 0x3c);
  iVar48 = param_3 * 0xc + param_2;
  fVar5 = *(float *)(iVar48 + 0x1e4);
  fVar6 = *(float *)(iVar48 + 0x1e8);
  fVar7 = *(float *)(iVar48 + 0x1ec);
  fVar8 = *(float *)(param_3 * 4 + param_2 + 0x214);
  iVar49 = *(int *)(param_2 + 0x22c);
  ...
  iVar30 = piVar41[2];
  iVar29 = piVar41[7];
  fVar2 = (float)((double)CONCAT44(0x43300000,*param_1 ^ 0x80000000) - DAT_80333818);
  iVar50 = 0x9f;
  do {
    fVar15 = fVar2;
    if (iVar49 != 0) {
      pfVar47 = *(float **)(iVar42 + 0x234);
      pfVar44 = *(float **)(iVar42 + 0x244);
      fVar15 = *pfVar44;
      *pfVar44 = fVar2;
      pfVar46 = pfVar44 + 1;
    ...
    *(float *)(iVar40 + iVar26) = fVar15;
    ...
    iVar25 = iVar25 + 4;
    fVar8 = fVar4 * fVar8 + -fVar15 * fVar19;
    if (iVar26 == iVar29) {
      iVar26 = 0;
    }
    iVar40 = piVar41[0xd];
    ...
    *(float *)(iVar40 + iVar24) = fVar15;
    ...
    fVar2 = (float)((double)CONCAT44(0x43300000,uVar45 ^ 0x80000000) - dVar20);
  ...
  *(float *)(iVar21 + iVar26) = fVar9;
  ...
  iVar25 = iVar25 + 4;
  fVar4 = fVar4 * fVar8 + -(fVar3 * fVar9 - fVar13) * fVar19;
  if (iVar26 == iVar29) {
    iVar26 = 0;
  }
  iVar22 = piVar41[0xd];
  ...
  *piVar41 = iVar28;
  ...
  piVar41[9] = iVar21;
  piVar41[0xe] = iVar22;
  *(float *)(param_3 * 4 + param_2 + 0x214) = fVar4;
  return;
}
