...
enum RedEntryWaveAramLayout {
	...
	REDSOUND_WAVE_DEFAULT_REGION_OFFSET = 0,
	REDSOUND_WAVE_LARGE_LOAD_STEP = 0x200000,
	REDSOUND_WAVE_DEFAULT_REGION_SIZE = 0x300000,
	REDSOUND_WAVE_FIXED_REGION_OFFSET = REDSOUND_WAVE_DEFAULT_REGION_OFFSET + REDSOUND_WAVE_DEFAULT_REGION_SIZE,
	REDSOUND_WAVE_FIXED_REGION_SIZE = 0x100000,
	REDSOUND_WAVE_LARGE_REGION_OFFSET = REDSOUND_WAVE_FIXED_REGION_OFFSET + REDSOUND_WAVE_FIXED_REGION_SIZE,
