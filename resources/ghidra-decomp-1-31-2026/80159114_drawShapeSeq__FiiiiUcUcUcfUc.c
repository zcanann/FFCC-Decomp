// Function: drawShapeSeq__FiiiiUcUcUcfUc
// Entry: 80159114
// Size: 740 bytes

/* WARNING: Removing unreachable block (ram,0x801593dc) */
/* WARNING: Removing unreachable block (ram,0x80159124) */

void drawShapeSeq__FiiiiUcUcUcfUc
               (double param_1,int param_2,int param_3,uint param_4,uint param_5,undefined param_6,
...

{
  ...
  local_bc.value[0][0] = FLOAT_80332d78;
  if (param_7 != '\0') {
    local_bc.value[0][0] = FLOAT_80332dd0;
  }
  local_bc.value[1][1] = FLOAT_80332dd0;
  if (param_8 != '\0') {
    local_bc.value[1][1] = FLOAT_80332d78;
  }
  ...
  MStack_8c.value[2][3] = (float)((double)MStack_8c.value[2][3] + param_1);
  GXSetProjection(&MStack_8c,1);
  iVar1 = **(int **)(*(int *)pppEnvStPtr->m_particleColors[0].m_colorRGBA + param_2 * 4);
  local_c8 = CONCAT31((int3)((uint)DAT_80332d00 >> 8),param_6);
  iVar1 = iVar1 + *(short *)(iVar1 + param_3 * 8 + 0x10);
