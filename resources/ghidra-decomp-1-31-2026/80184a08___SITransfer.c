...
undefined4
__SITransfer(uint param_1,undefined4 *param_2,int param_3,undefined4 param_4,int param_5,int param_6
            )

{
  ...
  OSDisableInterrupts();
  if (DAT_80217304 == 0xffffffff) {
    uVar2 = DAT_cc006438;
    DAT_cc006438 = uVar2 & 0xf000000 >> ((param_1 & 7) << 3);
    uVar2 = param_3 + 3U >> 2;
    uVar6 = 0;
    DAT_80217304 = param_1;
    DAT_8021730c = param_5;
    DAT_80217310 = param_4;
    DAT_80217314 = param_6;
    if (uVar2 != 0) {
      if (8 < uVar2) {
        uVar9 = uVar2 - 1 >> 3;
        puVar7 = &DAT_cc006400;
