...
static inline void ImageBufferSetPixel_IA8(HSD_ImageBuffer* imageBuffer, u32 x, u32 y, u32 intensity, u32 alpha, u32, u32);
 ...
 * JP Size: TODO
 */
static inline void MakeRefractionMap(HSD_ImageBuffer* imageBuffer)
{
    u32 y;
    u32 x;
    float magnitude;
