...
enum RedControlRampLayout {
	REDSOUND_CONTROL_RAMP_VALUE_OFFSET = 0,
	REDSOUND_CONTROL_RAMP_STEP_OFFSET = REDSOUND_CONTROL_RAMP_VALUE_OFFSET + sizeof(int),
	REDSOUND_CONTROL_RAMP_COUNT_OFFSET = REDSOUND_CONTROL_RAMP_STEP_OFFSET + sizeof(int),
...
enum RedReverbDepthLayout {
	REDSOUND_REVERB_DEPTH_DEPTH_OFFSET = 0,
	REDSOUND_REVERB_DEPTH_STEP_OFFSET = REDSOUND_REVERB_DEPTH_DEPTH_OFFSET + sizeof(int),
	REDSOUND_REVERB_DEPTH_COUNT_OFFSET = REDSOUND_REVERB_DEPTH_STEP_OFFSET + sizeof(int),
...
enum RedSoundLayoutSize {
	...
	REDSOUND_CONTROL_MASTER_VOLUME_OFFSET = (REDSOUND_CONTROL_TEMPO_WORD_OFFSET + 3) * sizeof(int),
	REDSOUND_CONTROL_MASTER_VOLUME_ADD_OFFSET = REDSOUND_CONTROL_MASTER_VOLUME_OFFSET + sizeof(int),
	REDSOUND_CONTROL_MASTER_VOLUME_DELTA_OFFSET = REDSOUND_CONTROL_MASTER_VOLUME_ADD_OFFSET + sizeof(int),
	REDSOUND_CONTROL_MUSIC_ID_OFFSET = REDSOUND_CONTROL_FLAGS_OFFSET + sizeof(unsigned int),
