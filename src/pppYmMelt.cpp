...
STATIC_ASSERT(sizeof(YmMeltCylinder) == sizeof(CMapCylinder));
STATIC_ASSERT(offsetof(YmMeltCylinder, m_boundsMin) == offsetof(CMapCylinder, m_boundsMin));
