...

{
  ...
  puVar1 = (undefined4 *)((int)(&pppMana2->field0_0x0 + 2) + param_2->m_serializedDataOffsets[2]);
  ...
  *puVar1 = 0;
  ...
  puVar1[0xc] = 0;
  puVar1[0xd] = 0;
  *(undefined *)(puVar1 + 0x38) = 0xff;
  PSMTXIdentity((Mtx *)(puVar1 + 0x20));
  PSMTXIdentity((Mtx *)(puVar1 + 0x2c));
