...
extern unsigned int DAT_80332D04;
extern unsigned int DAT_80332D08;
extern unsigned int DAT_80332D0C;
...
extern char s_Slash_80332d84[2];
extern char s_DecimalFormat_80332d14[3];
extern char s_TwoDigitFormat_80332d18[5];
extern char s_Colon_80332d30[2];
extern char s_PlusOne_80332d38[3];
extern char s_StringFormat_80332d40[3];
extern char s_StringDecimalFormat_80332d44[5];
extern char s_Plus_80332d4c[2];
extern char s_Minus_80332d50[2];
extern char lbl_80332E40[2];
...
__declspec(section ".sdata2") unsigned int gShopMenuAmbientWhite = 0xffffffff;
__declspec(section ".sdata2") unsigned int gShopMenuMaterialWhiteBase = 0xffffffff;
__declspec(section ".sdata2") unsigned int DAT_80332D04 = 0xffffffff;
__declspec(section ".sdata2") unsigned int DAT_80332D08 = 0xffffffff;
__declspec(section ".sdata2") unsigned int DAT_80332D0C = 0xffffffff;
__declspec(section ".sdata2") float FLOAT_80332D10 = -4.0f;
__declspec(section ".sdata2") char s_DecimalFormat_80332d14[3] = "%d";
__declspec(section ".sdata2") char s_TwoDigitFormat_80332d18[5] = "%02d";
__declspec(section ".sdata2") double DOUBLE_80332D20 = 4503601774854144.0;
__declspec(section ".sdata2") float FLOAT_80332d28 = 1.0f;
__declspec(section ".sdata2") float FLOAT_80332d2c = 0.8f;
__declspec(section ".sdata2") char s_Colon_80332d30[2] = ":";
__declspec(section ".sdata2") float FLOAT_80332d34 = -5.0f;
__declspec(section ".sdata2") char s_PlusOne_80332d38[3] = "+1";
__declspec(section ".sdata2") float FLOAT_80332d3c = 264.0f;
__declspec(section ".sdata2") char s_StringFormat_80332d40[3] = "%s";
__declspec(section ".sdata2") char s_StringDecimalFormat_80332d44[5] = "%s%d";
__declspec(section ".sdata2") char s_Plus_80332d4c[2] = "+";
__declspec(section ".sdata2") char s_Minus_80332d50[2] = "-";
__declspec(section ".sdata2") float FLOAT_80332d54 = 100.0f;
__declspec(section ".sdata2") float FLOAT_80332d58 = 104.0f;
__declspec(section ".sdata2") float FLOAT_80332d5c = 8.0f;
__declspec(section ".sdata2") float FLOAT_80332d60 = 0.25f;
__declspec(section ".sdata2") float FLOAT_80332d64 = -6.0f;
__declspec(section ".sdata2") float FLOAT_80332d68 = 136.0f;
__declspec(section ".sdata2") float FLOAT_80332d6c = 172.0f;
__declspec(section ".sdata2") float FLOAT_80332d70 = 259.0f;
__declspec(section ".sdata2") float FLOAT_80332d74 = 18.0f;
__declspec(section ".sdata2") float FLOAT_80332d78 = 0.5f;
__declspec(section ".sdata2") float FLOAT_80332d7c = 352.0f;
__declspec(section ".sdata2") float FLOAT_80332d80 = 300.0f;
__declspec(section ".sdata2") char s_Slash_80332d84[2] = "/";
__declspec(section ".sdata2") float FLOAT_80332d88 = 340.0f;
__declspec(section ".sdata2") float FLOAT_80332d8c = 1.5f;
__declspec(section ".sdata2") float FLOAT_80332d90 = 336.0f;
__declspec(section ".sdata2") float FLOAT_80332d94 = 558.0f;
__declspec(section ".sdata2") float FLOAT_80332d98 = 348.0f;
__declspec(section ".sdata2") float FLOAT_80332D9C = 0.0f;
__declspec(section ".sdata2") double DOUBLE_80332DA0 = 255.0;
__declspec(section ".sdata2") double DOUBLE_80332DA8 = 0.5;
__declspec(section ".sdata2") double DOUBLE_80332DB0 = 0.05;
__declspec(section ".sdata2") double DOUBLE_80332DB8 = 0.7;
__declspec(section ".sdata2") double DOUBLE_80332DC0 = 0.03;
__declspec(section ".sdata2") float FLOAT_80332DC8 = 0.7f;
__declspec(section ".sdata2") float FLOAT_80332DCC = 0.4f;
__declspec(section ".sdata2") float FLOAT_80332DD0 = -0.5f;
__declspec(section ".sdata2") float FLOAT_80332DD4 = 88.0f;
__declspec(section ".sdata2") float FLOAT_80332DD8 = 308.0f;
__declspec(section ".sdata2") float FLOAT_80332DDC = 332.0f;
__declspec(section ".sdata2") float FLOAT_80332DE0 = 255.0f;
__declspec(section ".sdata2") float FLOAT_80332DE4 = 320.0f;
__declspec(section ".sdata2") float FLOAT_80332DE8 = 224.0f;
__declspec(section ".sdata2") float FLOAT_80332DEC = 448.0f;
__declspec(section ".sdata2") float FLOAT_80332DF0 = -640.0f;
__declspec(section ".sdata2") float FLOAT_80332DF4 = -448.0f;
__declspec(section ".sdata2") float FLOAT_80332DF8 = 1279.0f;
__declspec(section ".sdata2") float FLOAT_80332DFC = 895.0f;
__declspec(section ".sdata2") float FLOAT_80332E00 = 70.0f;
__declspec(section ".sdata2") float FLOAT_80332E04 = 316.0f;
__declspec(section ".sdata2") float FLOAT_80332E08 = 54.0f;
__declspec(section ".sdata2") float FLOAT_80332E0C = -2.0f;
__declspec(section ".sdata2") float FLOAT_80332E10 = 312.0f;
__declspec(section ".sdata2") float FLOAT_80332E14 = 180.0f;
__declspec(section ".sdata2") float FLOAT_80332E18 = 520.0f;
__declspec(section ".sdata2") float FLOAT_80332E1C = 192.0f;
__declspec(section ".sdata2") float FLOAT_80332E20 = 144.0f;
__declspec(section ".sdata2") float FLOAT_80332E24 = 96.0f;
__declspec(section ".sdata2") float FLOAT_80332E28 = 344.0f;
__declspec(section ".sdata2") float FLOAT_80332E2C = 200.0f;
__declspec(section ".sdata2") float FLOAT_80332E30 = 260.0f;
__declspec(section ".sdata2") float FLOAT_80332E34 = 36.0f;
__declspec(section ".sdata2") float FLOAT_80332E38 = 384.0f;
__declspec(section ".sdata2") float FLOAT_80332E3C = 120.0f;
__declspec(section ".sdata2") char lbl_80332E40[2] = "x";
__declspec(section ".sdata2") float FLOAT_80332E44 = 356.0f;
__declspec(section ".sdata2") float FLOAT_80332e48 = 40.0f;
__declspec(section ".sdata2") float FLOAT_80332e4c = 250.0f;
__declspec(section ".sdata2") float FLOAT_80332E50 = 0.125f;
__declspec(section ".sdata2") char s_shop_80332e54[5] = "shop";
...
static inline void DrawShopMenuAmount(CFont* font, int value, float rightEdge, float y, int tlut)
{
...
static inline void DrawShopMenuRightAlignedText(CFont* font, const char* text, float rightEdge, float y, int tlut)
{
    if (text == 0) {
        return;
    }
...
static inline void DrawShopMenuRightAlignedTextTrunc(CFont* font, const char* text, float rightEdge, float y, int tlut)
{
    if (text == 0) {
        return;
    }
...
static inline void SetupShopMenuLabelFont(CFont* font)
{
    font->DrawInit();
    font->SetMargin(FLOAT_80332d28);
    font->SetShadow(0);
...
static inline void DrawShopMenuCenteredText(CFont* font, const char* text, float centerX, float y)
{
    if (text == 0) {
        return;
    }
...
static inline int GetShopMenuFigureStep(CShopMenu* shopMenu)
{
