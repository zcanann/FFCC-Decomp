...
extern const float kPppYmMeltCylinderBoundAndZero = -10000000000.0f;
u32 g_ymMelt;
}
    ...
    VERTEX_DATA* vertexData, YmMeltVertex* vertexBuffer, _GXColor* color, float yOffset)
{
    ...
    for (i = 0; i < pointCount; i++) {
        ...
        CMapCylinder cylinder(LoadFloat(kPppYmMeltCylinderRadius), kPppYmMeltCylinderBoundAndZero);
