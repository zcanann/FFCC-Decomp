...
static const char s_emptyErrorText[4] = "";
...
static const char s_closeWarnFmt[] = {0x93, 0xC7, 0x82, 0xDD, 0x8D, 0x9E, 0x82, 0xDD, 0x93, 0x72, 0x92, 0x86, 0x82, 0xC5, 0x63, 0x6C, 0x6F, 0x73, 0x65, 0x82, 0xB5, 0x82, 0xDC, 0x82, 0xB5, 0x82, 0xBD, 0x81, 0x42, 0x25, 0x73, 0x0A, 0x00, 0x00, 0x00, 0x00};
...
void CFile::Init()
{
    ...
    void* handlePoolBlock = operator new[](0x5610, (CMemory::CStage*)m_allocStage, const_cast<char*>(s_fileCpp), 0x2e);
    m_handlePoolHead.m_currentOffset =
        (u32)__construct_new_array(handlePoolBlock, 0, 0, sizeof(CHandle), 0x80);
