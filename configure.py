...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "p_camera.cpp", extra_cflags=["-RTTI on"]),
            Object(NonMatching, "p_chara.cpp", extra_cflags=["-RTTI on"]),
            Object(NonMatching, "p_chara_viewer.cpp"),
            Object(NonMatching, "p_dbgmenu.cpp", extra_cflags=["-RTTI on"]),
            Object(NonMatching, "p_FunnyShape.cpp", extra_cflags=["-RTTI on"]),
            Object(NonMatching, "p_game.cpp", extra_cflags=["-RTTI on"]),
            Object(NonMatching, "p_gba.cpp", extra_cflags=["-RTTI on"]),
            Object(NonMatching, "p_graphic.cpp", extra_cflags=["-RTTI on"]),
