...
#define RedMemoryBankGetAuxBank(bank, bankSize) ((RedMemoryBlock*)((unsigned char*)(bank) + (bankSize)))
#define RedMemoryBankGetDataBuffer(bank, bankSize) ((int)((unsigned char*)(bank) + (bankSize)))
