// Function: ShowMapMeshID__7CMapMngFii
// Entry: 8002f59c
// Size: 84 bytes

void ShowMapMeshID__7CMapMngFii(CMapMng *mapMng,uint param_2,int param_3)

{
  ...
  for (iVar2 = 0; iVar2 < mapMng->field10_0xc; iVar2 = iVar2 + 1) {
    if (*(ushort *)&pCVar1->mapObjArr[0].field_0x34 == param_2) {
      if (param_3 == 0) {
