// Function: SendArtifact__6JoyBusFP11ThreadParam
// Entry: 800a8cbc
// Size: 704 bytes

/* WARNING: Removing unreachable block (ram,0x800a8cf4) */

JoyBus * SendArtifact__6JoyBusFP11ThreadParam(JoyBus *joyBus,ThreadParam *threadParam)

{
  ...
  if (threadParam->m_subState == '\x01') {
    ...
    if (threadParam->m_subState == '\0') {
      ...
      local_118 = 8;
      iVar1 = GetArtifactData__8GbaQueueFiPUc(&GbaQue,threadParam->m_portIndex,auStack_117);
      pJVar2 = (JoyBus *)
