...
void pppRandHCV(void* p1, void* p2, void* p3)
{
    ...
    target[0] += (s8)((f32)params->field8 * scale - (f32)params->field8);
    target[1] += (s8)((f32)params->fieldA * scale - (f32)params->fieldA);
    target[2] += (s8)((f32)params->fieldC * scale - (f32)params->fieldC);
    target[3] += (s8)((f32)params->fieldE * scale - (f32)params->fieldE);
}
