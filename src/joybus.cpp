 ...
 * Size:	........
 */
inline int JoyBus::WriteInitialCode(ThreadParam* threadParam)
{
 ...
 * Size:	........
 */
inline int JoyBus::ReadHostId(ThreadParam* threadParam)
{
 ...
 * Size:	........
 */
inline int JoyBus::WriteHostId(ThreadParam* threadParam)
{
    bool singleMode = GbaQue.IsSingleMode(threadParam->m_portIndex);
 ...
 * Size:	........
 */
inline int JoyBus::WriteContext(ThreadParam* threadParam)
{
    unsigned int word;
    ...
    {
        portVal = threadParam->m_portIndex;
    }
...
int JoyBus::InitialCode(ThreadParam* threadParam)
{
    ...
    case 2:
        status = ReadContext(threadParam);
    ...
    case 4:
        status = WriteHostId(threadParam);
    ...
    case 5:
        status = WriteContext(threadParam);
...
{
    unsigned char* temp = m_perThreadTemp[threadParam->m_portIndex];
    ...
    if ((gbaStatus & 1) != 0)
    {
        ...
        if ((localBytes[0] & 0x3F) == 7)
        {
            ...
            int typeVal = static_cast<signed char>(sendType);
            int respVal = localBytes[1];
    ...
    else if (static_cast<signed char>(phase) == 2 && step >= chunkCount)
    {
        return -1;
    }
    ...
    if (static_cast<signed char>(phase) == 0)
    {
        if (step == 0)
        {
            ...
            crcTmp = 0xFFFF;
            crc = swapTmp = Crc16(totalSize, dataBase, &crcTmp);
    ...
    else if (static_cast<signed char>(phase) == 1)
    {
        localBytes[0] |= 0x40;
...
int JoyBus::SendItemAll(ThreadParam* threadParam)
{
    ...
    case 0:
    {
            ...
            unsigned char payload[kJoyDataLargePayloadClearBytes];
...
int JoyBus::SendMapObj(ThreadParam* threadParam)
{
    ...
    case 0:
    {
            ...
            unsigned char payload[kJoyDataMapPayloadClearBytes];
...
int JoyBus::SendCompatibility(ThreadParam* threadParam)
{
    ...
    {
            m_txWordIndex[threadParam->m_portIndex] = 0;
            unsigned char payload[kJoyDataSmallPayloadClearBytes];
...
int JoyBus::SendFavorite(ThreadParam* threadParam)
{
    ...
    case 0:
    {
            unsigned char payload[kJoyDataFavoritePayloadClearBytes];
