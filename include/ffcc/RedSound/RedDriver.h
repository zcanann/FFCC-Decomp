...
enum RedDmaRequestLayout {
	REDSOUND_DMA_REQUEST_ID_OFFSET = 0,
	REDSOUND_DMA_REQUEST_DIRECTION_OFFSET = REDSOUND_DMA_REQUEST_ID_OFFSET + sizeof(int),
	REDSOUND_DMA_REQUEST_MAIN_MEMORY_OFFSET = REDSOUND_DMA_REQUEST_DIRECTION_OFFSET + sizeof(int),
	REDSOUND_DMA_REQUEST_ARAM_MEMORY_OFFSET = REDSOUND_DMA_REQUEST_MAIN_MEMORY_OFFSET + sizeof(int),
	REDSOUND_DMA_REQUEST_SIZE_OFFSET = REDSOUND_DMA_REQUEST_ARAM_MEMORY_OFFSET + sizeof(int),
	REDSOUND_DMA_REQUEST_CALLBACK_OFFSET = REDSOUND_DMA_REQUEST_SIZE_OFFSET + sizeof(int),
	REDSOUND_DMA_REQUEST_CALLBACK_DATA_OFFSET = REDSOUND_DMA_REQUEST_CALLBACK_OFFSET + sizeof(RedDmaCallback),
