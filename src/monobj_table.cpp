...
extern "C" MonAiFuncTable funcsOrcKing = {
    ...
    &CGMonObj::logicFuncDefault,
    0,
    (MonCalcFunc)&CGMonObj::calcBranchFuncOrcKing,
    0,
    0,
    0,
...
extern "C" MonAiFuncTable funcsGolem = {
    ...
    &CGMonObj::logicFuncDefault,
    0,
    (MonCalcFunc)&CGMonObj::calcBranchFuncGolem,
...
extern "C" MonAiFuncTable funcsDragonZombie = {
    ...
    &CGMonObj::logicFuncDefault,
    0,
    (MonCalcFunc)&CGMonObj::calcBranchFuncDragonZombie,
    0,
    0,
    0,
    &CGMonObj::alwaysFuncDefault,
...
extern "C" MonAiFuncTable funcsTetsukyojin = {
    ...
    &CGMonObj::logicFuncDefault,
    0,
    (MonCalcFunc)&CGMonObj::calcBranchFuncTetsukyojin,
    0,
    0,
    0,
    &CGMonObj::alwaysFuncDefault,
...
extern "C" MonAiFuncTable funcsLich = {
    ...
    &CGMonObj::logicFuncDefault,
    0,
    (MonCalcFunc)&CGMonObj::calcBranchFuncLich,
    0,
    0,
    0,
    &CGMonObj::alwaysFuncDefault,
...
extern "C" MonAiFuncTable funcsLastBoss = {
    ...
    0,
    (MonCalcFunc)&CGMonObj::calcBranchFuncLastBoss,
