// Function: pppDestructChangeTex
// Entry: 8013f504
// Size: 540 bytes

/* WARNING: Struct "CGBaseObj": ignoring overlapping field "vtable" */

void pppDestructChangeTex(pppChangeTex *pppChangeTex,UnkC *param_2)

{
  ...
  handle = (CCharaPcsCHandle *)
           GetCharaHandlePtr__FP8CGObjectl(*(CGObject **)(&pppChangeTex->field_0x98 + iVar1),0);
  handle_00 = (CCharaPcsCHandle *)
              GetCharaHandlePtr__FP8CGObjectl(*(CGObject **)(&pppChangeTex->field_0x98 + iVar1),1);
  handle_01 = (CCharaPcsCHandle *)
              GetCharaHandlePtr__FP8CGObjectl(*(CGObject **)(&pppChangeTex->field_0x98 + iVar1),2);
  iVar6 = 0;
  ...
  if ((handle_00 != (CCharaPcsCHandle *)0x0) &&
     (iVar2 = GetCharaModelPtr__FPQ29CCharaPcs7CHandle(handle_00), iVar2 != 0)) {
  ...
  if ((handle_01 != (CCharaPcsCHandle *)0x0) &&
     (iVar2 = GetCharaModelPtr__FPQ29CCharaPcs7CHandle(handle_01), iVar2 != 0)) {
    *(undefined4 *)(iVar2 + 0xe4) = 0;
    *(undefined4 *)(iVar2 + 0xe8) = 0;
    *(undefined4 *)(iVar2 + 0xf4) = 0;
    *(undefined4 *)(iVar2 + 0xfc) = 0;
  ...
  stage = *(CStage **)(&pppChangeTex->field_0x90 + iVar1);
  if ((stage != (CStage *)0x0) &&
     (stage_00 = *(CStage **)(&pppChangeTex->field_0x8c + iVar1), stage_00 != (CStage *)0x0)) {
    ...
    for (uVar5 = 0; uVar5 < *(uint *)(*(int *)(iVar6 + 0xa4) + 0xc); uVar5 = uVar5 + 1) {
      ...
      for (uVar3 = 0; uVar3 < *(uint *)(iVar2 + 0x4c); uVar3 = uVar3 + 1) {
