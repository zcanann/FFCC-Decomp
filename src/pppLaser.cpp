...
STATIC_ASSERT(sizeof(LaserCylinder) == sizeof(CMapCylinder));
STATIC_ASSERT(offsetof(LaserCylinder, m_boundsMin) == offsetof(CMapCylinder, m_boundsMin));
