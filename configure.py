...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "joybus.cpp", extra_cflags=["-inline auto,deferred", "-str reuse,readonly"]),
            ...
            Object(NonMatching, "p_minigame.cpp", extra_cflags=["-inline auto,deferred", "-RTTI on", "-sdata 8", "-common off", "-str reuse,readonly"]),
            Object(NonMatching, "p_sample.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
