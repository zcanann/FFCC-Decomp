...
void CMenuPcs::ArtiInit1()
{
	...
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x24) = 0x2e;
	*(int*)(artiListBase + 0x2c) = 2;
	*(int*)(artiListBase + 0x30) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x64) = 0x44;
	*(int*)(artiListBase + 0x6c) = 7;
	*(int*)(artiListBase + 0x70) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0xa4) = 0x44;
	*(int*)(artiListBase + 0xac) = 7;
	*(int*)(artiListBase + 0xb0) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0xf4) = 2;
	*(int*)(artiListBase + 0xe4) = 0x2e;
	*(int*)(artiListBase + 0xec) = 7;
	*(int*)(artiListBase + 0xf0) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x134) = 2;
	*(int*)(artiListBase + 0x124) = 0x37;
	*(int*)(artiListBase + 0x12c) = 0;
	*(int*)(artiListBase + 0x130) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x174) = 2;
	*(int*)(artiListBase + 0x164) = 0x37;
	*(int*)(artiListBase + 0x16c) = 0;
	*(int*)(artiListBase + 0x170) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x1b4) = 2;
	*(int*)(artiListBase + 0x1a4) = 0x37;
	*(int*)(artiListBase + 0x1ac) = 0;
	*(int*)(artiListBase + 0x1b0) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x1f4) = 2;
	*(int*)(artiListBase + 0x1e4) = 0x37;
	alpha = FLOAT_80332fac;
	*(int*)(artiListBase + 0x1ec) = 0;
	*(int*)(artiListBase + 0x1f0) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x234) = 2;
	*(int*)(artiListBase + 0x224) = 0x37;
	*(int*)(artiListBase + 0x22c) = 0;
	*(int*)(artiListBase + 0x230) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x274) = 2;
	*(int*)(artiListBase + 0x264) = 0x37;
	*(int*)(artiListBase + 0x26c) = 0;
	*(int*)(artiListBase + 0x270) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x2b4) = 2;
	*(int*)(artiListBase + 0x2a4) = 0x37;
	*(int*)(artiListBase + 0x2ac) = 0;
	*(int*)(artiListBase + 0x2b0) = 5;
	artiListBase = GetArtiListBase(this);
	*(int*)(artiListBase + 0x2f4) = 2;
	*(int*)(artiListBase + 0x2e4) = 0x37;
	*(int*)(artiListBase + 0x2ec) = 0;
	*(int*)(artiListBase + 0x2f0) = 5;
		...
		if (blocks != 0) {
			do {
				...
				*(float*)(entry + 8) = alpha;
				entry[0x30] = 0;
				entry[0x31] = 0;
				*(float*)(entry + 0x28) = alpha;
				entry[0x50] = 0;
				entry[0x51] = 0;
				*(float*)(entry + 0x48) = alpha;
				entry[0x70] = 0;
				entry[0x71] = 0;
				*(float*)(entry + 0x68) = alpha;
				entry[0x90] = 0;
				entry[0x91] = 0;
				*(float*)(entry + 0x88) = alpha;
				entry[0xb0] = 0;
				entry[0xb1] = 0;
				*(float*)(entry + 0xa8) = alpha;
				entry[0xd0] = 0;
				entry[0xd1] = 0;
				*(float*)(entry + 200) = alpha;
				entry[0xf0] = 0;
				entry[0xf1] = 0;
				*(float*)(entry + 0xe8) = alpha;
				entry += 0x100;
				blocks--;
			} while (blocks != 0);
			count &= 7;
