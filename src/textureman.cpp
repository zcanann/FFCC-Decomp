...
void CTexture::SetExternalTlut(void* tlutData, int loadToGX)
{
    ...
    GXInitTlutObj(&m_tlutObj1,
                  static_cast<u8*>(tlutData)
                      + ((m_format == GX_TF_C8) ? kTextureC8TlutEntries : kTextureC4TlutEntries) * 2,
                  GX_TL_IA8, (m_format == GX_TF_C8) ? kTextureC8TlutEntries : kTextureC4TlutEntries);
