...

{
  ...
  *param_3 = *param_3 & 0x3fffffff;
  ...
  DAT_8030cb66 = (short)*param_2;
  DAT_8030cb64 = (ushort)(iVar3 << 0xc) |
                 (ushort)(*param_2 >> 0x10) | (ushort)*(byte *)(param_1 + 0x3c) << 8;
  DAT_8030cb6e = (short)*param_3;
  DAT_8030cb6c = (short)(*param_3 >> 0x10);
  uVar2 = DAT_8032f108 | 0x33000;
  if (*(int *)(param_1 + 0x44) != 0) {
    DAT_8030cb6a = (undefined2)*param_4;
    DAT_8030cb68 = (undefined2)(*param_4 >> 0x10);
    DAT_8030cb72 = (undefined2)*param_5;
    DAT_8030cb70 = (undefined2)(*param_5 >> 0x10);
    uVar2 = DAT_8032f108 | 0x3fc00;
  }
  DAT_8032f108 = uVar2;
  return;
}
