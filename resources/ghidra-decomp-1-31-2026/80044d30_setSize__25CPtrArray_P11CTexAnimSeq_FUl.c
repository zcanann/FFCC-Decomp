// Function: setSize__25CPtrArray<P11CTexAnimSeq>FUl
// Entry: 80044d30
// Size: 240 bytes

undefined4 setSize__25CPtrArray<P11CTexAnimSeq>FUl(CPtrArray *ptrArray,uint size)
  ...
  if (ptrArray->size < size) {
    if (ptrArray->size == 0) {
      ...
      if (ptrArray->growCapacity == 0) {
        Printf__7CSystemFPce(&System,&DAT_801d7b14);
      }
    ...
    dstBuffer = (void **)_Alloc__7CMemoryFUlPQ27CMemory6CStagePcii
                                   (&Memory,ptrArray->size << 2,ptrArray->stage,
                                    s_collection_ptrarray_h_801d7b30,0xfa,0);
