...
enum RedReverbLayoutOffset {
	...
	REDSOUND_REVERB_CONTEXT_OFFSET = REDSOUND_REVERB_CALLBACK_OFFSET + sizeof(int),
	REDSOUND_REVERB_KIND_OFFSET = REDSOUND_REVERB_CONTEXT_OFFSET + sizeof(void*),
...
enum RedReverbSizeLayoutOffset {
	...
	REDSOUND_REVERB_SIZE_ALIGNED_OFFSET = REDSOUND_REVERB_SIZE_REQUESTED_OFFSET + sizeof(u32),
...
enum RedNoteLayoutOffset {
	...
	REDSOUND_NOTE_VELOCITY_OFFSET = REDSOUND_NOTE_KEY_OFFSET + sizeof(signed char),
	REDSOUND_NOTE_ALLOC_FLAGS_OFFSET = REDSOUND_NOTE_VELOCITY_OFFSET + sizeof(signed char),
	REDSOUND_NOTE_RESERVED03_OFFSET = REDSOUND_NOTE_ALLOC_FLAGS_OFFSET + sizeof(unsigned char),
...
enum RedWaveAdpcmLayoutOffset {
	REDSOUND_WAVE_ADPCM_DATA_OFFSET = 0,
	REDSOUND_WAVE_ADPCM_LOOP_OFFSET = REDSOUND_WAVE_ADPCM_DATA_OFFSET + sizeof(AXPBADPCM),
...
enum RedWaveLayoutOffset {
	REDSOUND_WAVE_FLAGS_OFFSET = 0,
	REDSOUND_WAVE_SAMPLE_START_OFFSET = REDSOUND_WAVE_FLAGS_OFFSET + sizeof(unsigned int),
	REDSOUND_WAVE_LOOP_START_OFFSET = REDSOUND_WAVE_SAMPLE_START_OFFSET + sizeof(int),
	REDSOUND_WAVE_LOOP_END_OFFSET = REDSOUND_WAVE_LOOP_START_OFFSET + sizeof(int),
	REDSOUND_WAVE_RESERVED10_OFFSET = REDSOUND_WAVE_LOOP_END_OFFSET + sizeof(int),
	REDSOUND_WAVE_PITCH_OFFSET = REDSOUND_WAVE_RESERVED10_OFFSET + REDSOUND_WAVE_RESERVED10_SIZE,
	REDSOUND_WAVE_SPLIT_KEY_OFFSET = REDSOUND_WAVE_PITCH_OFFSET + sizeof(int),
	REDSOUND_WAVE_SPLIT_VELOCITY_OFFSET = REDSOUND_WAVE_SPLIT_KEY_OFFSET + sizeof(signed char),
	REDSOUND_WAVE_VOLUME_OFFSET = REDSOUND_WAVE_SPLIT_VELOCITY_OFFSET + sizeof(unsigned char),
	REDSOUND_WAVE_PAN_OFFSET = REDSOUND_WAVE_VOLUME_OFFSET + sizeof(unsigned char),
	REDSOUND_WAVE_REVERB_MIX_OFFSET = REDSOUND_WAVE_PAN_OFFSET + sizeof(unsigned char),
	REDSOUND_WAVE_RESERVED1D_OFFSET = REDSOUND_WAVE_REVERB_MIX_OFFSET + sizeof(signed char),
	REDSOUND_WAVE_ADPCM_OFFSET = REDSOUND_WAVE_RESERVED1D_OFFSET + REDSOUND_WAVE_RESERVED1D_SIZE,
	REDSOUND_WAVE_ADSR_OFFSET = REDSOUND_WAVE_ADPCM_OFFSET + REDSOUND_WAVE_ADPCM_INFO_SIZE,
	REDSOUND_WAVE_RESERVED5C_OFFSET = REDSOUND_WAVE_ADSR_OFFSET + REDSOUND_WAVE_ADSR_SIZE,
};
...
enum RedVoiceLayoutOffset {
	REDSOUND_VOICE_TRACK_OFFSET = 0,
	REDSOUND_VOICE_KEY_OFFSET = REDSOUND_VOICE_TRACK_OFFSET + sizeof(RedTrackDATA*) + sizeof(RedWaveDATA*) +
	                            3 * sizeof(int*) + sizeof(AXVPB*),
	REDSOUND_VOICE_VELOCITY_OFFSET = REDSOUND_VOICE_KEY_OFFSET + sizeof(signed char),
	REDSOUND_VOICE_STATE_FLAGS_OFFSET = REDSOUND_VOICE_VELOCITY_OFFSET + sizeof(signed char),
	REDSOUND_VOICE_RESERVED1B_OFFSET = REDSOUND_VOICE_STATE_FLAGS_OFFSET + sizeof(unsigned char),
	REDSOUND_VOICE_RESERVED2A_OFFSET = REDSOUND_VOICE_RESERVED1B_OFFSET + REDSOUND_VOICE_RESERVED1B_SIZE +
	                                  3 * sizeof(int) + sizeof(short),
	REDSOUND_VOICE_RESERVED3A_OFFSET = REDSOUND_VOICE_RESERVED2A_OFFSET + REDSOUND_VOICE_RESERVED2A_SIZE +
	                                  3 * sizeof(int) + sizeof(short),
	REDSOUND_VOICE_RESERVED48_OFFSET =
	    REDSOUND_VOICE_RESERVED3A_OFFSET + REDSOUND_VOICE_RESERVED3A_SIZE + 3 * sizeof(int),
	REDSOUND_VOICE_ADSR_TIME_OFFSET = REDSOUND_VOICE_RESERVED48_OFFSET + REDSOUND_VOICE_RESERVED48_SIZE,
	REDSOUND_VOICE_ADSR_LEVEL_OFFSET = REDSOUND_VOICE_ADSR_TIME_OFFSET + REDSOUND_ADSR_LEVEL_OFFSET,
	REDSOUND_VOICE_ADSR_STAGE_OFFSET = REDSOUND_VOICE_ADSR_TIME_OFFSET + REDSOUND_ADSR_DATA_SIZE,
	REDSOUND_VOICE_ACTIVE_OFFSET = REDSOUND_VOICE_ADSR_STAGE_OFFSET + 3 * sizeof(int) + sizeof(AXPBMIX),
	REDSOUND_VOICE_FLAGS_OFFSET = REDSOUND_VOICE_ACTIVE_OFFSET + sizeof(int),
	REDSOUND_VOICE_SWITCH_OFFSET = REDSOUND_VOICE_FLAGS_OFFSET + sizeof(unsigned int),
	REDSOUND_VOICE_RESERVEDA4_OFFSET = REDSOUND_VOICE_SWITCH_OFFSET + sizeof(unsigned int) + 3 * sizeof(int),
	REDSOUND_VOICE_INDEX_OFFSET = REDSOUND_VOICE_RESERVEDA4_OFFSET + REDSOUND_VOICE_RESERVEDA4_SIZE,
	REDSOUND_VOICE_RESERVEDB4_OFFSET = REDSOUND_VOICE_INDEX_OFFSET + 3 * sizeof(int),
	REDSOUND_VOICE_UPDATE_FLAGS_OFFSET = REDSOUND_VOICE_RESERVEDB4_OFFSET + REDSOUND_VOICE_RESERVEDB4_SIZE,
	REDSOUND_VOICE_RESERVEDBC_OFFSET = REDSOUND_VOICE_UPDATE_FLAGS_OFFSET + sizeof(unsigned int),
};
...
enum RedVoiceLayoutWord {
	...
	REDSOUND_VOICE_WAVE_DATA_WORD = REDSOUND_VOICE_TRACK_WORD + 1,
	REDSOUND_VOICE_TRACK_VOLUME_WORD = REDSOUND_VOICE_WAVE_DATA_WORD + 1,
	REDSOUND_VOICE_TRACK_EXPRESSION_WORD = REDSOUND_VOICE_TRACK_VOLUME_WORD + 1,
	REDSOUND_VOICE_TRACK_PAN_WORD = REDSOUND_VOICE_TRACK_EXPRESSION_WORD + 1,
	REDSOUND_VOICE_AX_VOICE_WORD = REDSOUND_VOICE_TRACK_PAN_WORD + 1,
	REDSOUND_VOICE_NOTE_WORD = REDSOUND_VOICE_AX_VOICE_WORD + 1,
	REDSOUND_VOICE_PITCH_MOD_PHASE_WORD = REDSOUND_VOICE_NOTE_WORD + 1,
	REDSOUND_VOICE_PITCH_MOD_FRAMES_WORD = REDSOUND_VOICE_PITCH_MOD_PHASE_WORD + 1,
	REDSOUND_VOICE_PITCH_MOD_FRAME_WORD = REDSOUND_VOICE_PITCH_MOD_FRAMES_WORD + 1,
	REDSOUND_VOICE_PITCH_MOD_DELAY_HALFWORD =
	    (REDSOUND_VOICE_PITCH_MOD_FRAME_WORD + 1) * sizeof(int) / sizeof(unsigned short),
	REDSOUND_VOICE_VOLUME_MOD_PHASE_WORD = REDSOUND_VOICE_PITCH_MOD_DELAY_HALFWORD / 2 + 1,
	REDSOUND_VOICE_VOLUME_MOD_FRAMES_WORD = REDSOUND_VOICE_VOLUME_MOD_PHASE_WORD + 1,
	REDSOUND_VOICE_VOLUME_MOD_FRAME_WORD = REDSOUND_VOICE_VOLUME_MOD_FRAMES_WORD + 1,
	REDSOUND_VOICE_VOLUME_MOD_DELAY_HALFWORD =
	    (REDSOUND_VOICE_VOLUME_MOD_FRAME_WORD + 1) * sizeof(int) / sizeof(unsigned short),
	REDSOUND_VOICE_RANDOM_PITCH_WORD = REDSOUND_VOICE_VOLUME_MOD_DELAY_HALFWORD / 2 + 1,
	REDSOUND_VOICE_RANDOM_VOLUME_WORD = REDSOUND_VOICE_RANDOM_PITCH_WORD + 1,
	REDSOUND_VOICE_RANDOM_PAN_WORD = REDSOUND_VOICE_RANDOM_VOLUME_WORD + 1,
	...
	REDSOUND_VOICE_PITCH_WORD = REDSOUND_VOICE_SWITCH_WORD + 1,
	REDSOUND_VOICE_TARGET_PITCH_WORD = REDSOUND_VOICE_PITCH_WORD + 1,
	REDSOUND_VOICE_BASE_PITCH_WORD = REDSOUND_VOICE_TARGET_PITCH_WORD + 1,
	REDSOUND_VOICE_ADSR_CURRENT_WORD = REDSOUND_VOICE_INDEX_WORD + 1,
	REDSOUND_VOICE_ENVELOPE_WORD = REDSOUND_VOICE_ADSR_CURRENT_WORD + 1,
