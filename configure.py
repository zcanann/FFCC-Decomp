...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "bonus_menu.cpp", extra_cflags=["-sdata 8"]),
            Object(Matching, "cflat_data.cpp"),
            Object(NonMatching, "cflat_r2class.cpp"),
            Object(
                NonMatching,
                "cflat_r2system.cpp",
                extra_cflags=["-inline auto,deferred", "-str reuse,pool,readonly", "-use_lmw_stmw off"],
            ),
            ...
            Object(NonMatching, "p_FunnyShape.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly"]),
            Object(Matching, "p_game.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
            Object(NonMatching, "p_gba.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly"]),
            Object(NonMatching, "p_graphic.cpp", cflags=[*cflags_game, "-RTTI on", "-sdata 8", "-str reuse,pool,readonly"]),
            Object(NonMatching, "p_light.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-inline auto,deferred", "-str reuse,pool,readonly"]),
            Object(NonMatching, "p_map.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-inline auto,deferred", "-str reuse,pool,readonly"]),
            Object(NonMatching, "p_MaterialEditor.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly"]),
            Object(NonMatching, "p_mc.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
            ...
            Object(NonMatching, "pppYmMiasma.cpp", cflags=cflags_game_cpp_exceptions),
            ...
            Object(NonMatching, "usb.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly"]),
