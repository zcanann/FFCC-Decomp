...
void pppRenderYmLaser(pppYmLaser* laser, pppLaserStep* step, _pppCtrlTable* ctrlTable);
void pppFrameYmLaser(pppYmLaser* laser, pppLaserStep* step, _pppCtrlTable* ctrlTable);
