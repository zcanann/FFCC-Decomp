           ...
           _PARTICLE_COLOR* particleColor)
{
    ...
    if ((mode >= 4) && (mode < 6) && (pYmMegaBirthShpTail3->m_speedRandRange != 0.0f)) {
        ...
        float speedRandHalf = kPppYmMegaBirthShpTail3Half * speedRandRange;
        ...
        if (randType <= 1) {
            ...
            particleData->m_matrix[0][0] =
                -(kPppYmMegaBirthShpTail3RandomSpeedScale * (speedRandRange * Math.RandF() * Math.RandF()) - speedRandRange) -
                speedRandHalf;
            ...
            particleData->m_matrix[0][0] = -(kPppYmMegaBirthShpTail3Half * (Math.RandF() *
                                                     (speedRandRange * Math.RandF() *
                                                      Math.RandF())) -
                                             speedRandRange) -
                                            speedRandHalf;
            particleData->m_matrix[0][1] = -(kPppYmMegaBirthShpTail3Half * (Math.RandF() *
                                                     (speedRandRange * Math.RandF() *
                                                      Math.RandF())) -
                                             speedRandRange) -
                                            speedRandHalf;
            particleData->m_matrix[0][2] = -(kPppYmMegaBirthShpTail3Half * (Math.RandF() *
                                                     (speedRandRange * Math.RandF() *
                                                      Math.RandF())) -
                                             speedRandRange) -
                                            speedRandHalf;
        ...
        if (randType == 3) {
            scale = -(kPppYmMegaBirthShpTail3RandomSpeedScale * (speedRandRange * Math.RandF() * Math.RandF()) - speedRandRange);
        } else if (randType == 1) {
            Math.RandF();
            ...
            scale = -(kPppYmMegaBirthShpTail3Half * (Math.RandF() *
