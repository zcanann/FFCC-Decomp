// Function: pppCacheDumpModelTexture__8CMapMeshFP12CMaterialSetP13CAmemCacheSet
// Entry: 80027774
// Size: 120 bytes

void pppCacheDumpModelTexture__8CMapMeshFP12CMaterialSetP13CAmemCacheSet
    ...
    if (*piVar2 != 0) {
      if (*(ushort *)(piVar2 + 2) == 0xffff) {
        *(undefined2 *)(piVar2 + 2) = 0;
        ...
        CacheDumpTexture__12CMaterialSetFiP13CAmemCacheSet
