...
void CMenuPcs::CompaInit()
{
	...
	CompaOpenAnim* entries = this->compaList->entries;
	entries[0].tex = 0x52;
	entries[0].drawFlags = 4;
	entries[0].x = 0x28;
	entries[0].y = 0x30;
	entries[0].w = 0x198;
	entries[0].h = 0x18;
	entries[0].u = FLOAT_80332FF8;
	entries[0].v = FLOAT_80332FF8;
	entries[0].uvScale = FLOAT_80333000;
	entries[0].startFrame = 5;
	entries[0].duration = 5;

	entries = this->compaList->entries;
	entries[1].tex = 0x51;
	entries[1].x = 0x28;
	entries[1].y = 0x48;
	entries[1].w = 0x198;
	entries[1].h = 200;
	entries[1].u = FLOAT_80332FF8;
	entries[1].v = FLOAT_80332FF8;
	entries[1].uvScale = FLOAT_80333000;
	entries[1].startFrame = 5;
	entries[1].duration = 5;
	...
	entries[2].w = 0x198;
	entries[2].h = 0x18;
	entries[2].u = FLOAT_80332FF8;
	entries[2].v = FLOAT_80332FF8;
	entries[2].uvScale = FLOAT_80333000;
	entries[2].startFrame = 5;
	entries[2].duration = 5;
	...
	entries[3].w = 0x30;
	entries[3].h = 0x30;
	entries[3].u = FLOAT_80332FF8;
	entries[3].v = FLOAT_80332FF8;
	entries[3].uvScale = FLOAT_80333000;
	entries[3].startFrame = 0;
	entries[3].duration = 5;
	...
	entries[4].w = 0x30;
	entries[4].h = 0x30;
	entries[4].y = static_cast<short>(0x150 - entries[4].h);
	entries[4].u = FLOAT_80332FF8;
	entries[4].v = FLOAT_80332FF8;
	entries[4].uvScale = FLOAT_80333038;
	entries[4].startFrame = 0;
	entries[4].duration = 5;

	entries = this->compaList->entries;
	entries[5].flags = 2;
	entries[5].drawFlags = 0x2e;
	entries[5].x = 0x10;
	entries[5].y = 8;
	entries[5].w = 0x30;
	entries[5].h = 0x140;
	entries[5].u = FLOAT_8033303C;
	entries[5].v = FLOAT_80332FF8;
	entries[5].startFrame = 0;
	entries[5].duration = 5;
