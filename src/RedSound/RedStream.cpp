...
enum RedStreamLayoutSize {
	...
	REDSOUND_STREAM_ARAM_HIGH_THRESHOLD = REDSOUND_WAVE_LARGE_REGION_OFFSET + REDSOUND_WAVE_LARGE_REGION_SIZE,
	REDSOUND_STREAM_ARAM_LOW_OFFSET = 0,
	REDSOUND_STREAM_ARAM_HIGH_OFFSET = REDSOUND_WAVE_DEFAULT_REGION_SIZE,
