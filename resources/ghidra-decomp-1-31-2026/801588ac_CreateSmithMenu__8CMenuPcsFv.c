// Function: CreateSmithMenu__8CMenuPcsFv
// Entry: 801588ac
// Size: 292 bytes

/* WARNING: Struct "CGBaseObj": ignoring overlapping field "vtable" */

void CreateSmithMenu__8CMenuPcsFv(CMenuPcs *menuPcs)

{
  ...
  pCVar1 = (CShopMenu *)__nw__FUlPQ27CMemory6CStagePci(0x158,uVar2,s_shopmenu_cpp_801ded8c,0x2e9);
  ...
  *(uint32_t *)&pCVar1->field_0x20 = Game.game.m_scriptFoodBase[0];
  SetMode__9CShopMenuFi(pCVar1,9);
