...
enum RedSoundLocalSize {
	...
	REDSOUND_STREAM_BANK_RESERVED14_SIZE = REDSOUND_STREAM_BANK_ENTRY_SIZE - REDSOUND_STREAM_BANK_RESERVED14_OFFSET,
...
struct RedSoundStreamBank {
	...
	int m_readPoint;
	int m_playPoint;
	u8 m_reserved14[REDSOUND_STREAM_BANK_RESERVED14_SIZE];
};
