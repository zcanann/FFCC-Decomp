// Function: pppFrameBreathModel
// Entry: 800db6e0
// Size: 1264 bytes

/* WARNING: Removing unreachable block (ram,0x800dbbb4) */
/* WARNING: Removing unreachable block (ram,0x800db6f0) */
/* WARNING: Struct "CGBaseObj": ignoring overlapping field "vtable" */

void pppFrameBreathModel(pppBreathModel *pppBreathModel,int param_2,int param_3)

{
  ...
  if (DAT_8032ed70 == 0) {
    ...
    dest = (Mtx *)((int)(&pppBreathModel->field0_0x0 + 2) + **(int **)(param_3 + 0xc));
    if (dest[1].value[0][0] == 0.0) {
      dest[1].value[1][0] = (float)(uint)*(ushort *)(param_2 + 0x1a);
      *(undefined2 *)((int)dest[1].value[2] + 6) = *(undefined2 *)(param_2 + 0x10);
      *(undefined2 *)(dest[1].value[2] + 1) = *(undefined2 *)(param_2 + 0x12);
      fVar4 = (float)pppMemAlloc__FUlPQ27CMemory6CStagePci
                               ((int)dest[1].value[1][0] * 0x98,pppEnvStPtr->m_stagePtr,
                                s_pppBreathModel_cpp_801db5a0,599);
      dest[1].value[0][0] = fVar4;
      fVar4 = dest[1].value[0][0];
      if (fVar4 != 0.0) {
        memset(fVar4,0,(int)dest[1].value[1][0] * 0x98);
      }
      fVar4 = (float)pppMemAlloc__FUlPQ27CMemory6CStagePci
                               ((int)dest[1].value[1][0] * 0x30,pppEnvStPtr->m_stagePtr,
                                s_pppBreathModel_cpp_801db5a0,0x25d);
      ...
      fVar4 = (float)pppMemAlloc__FUlPQ27CMemory6CStagePci
                               ((int)dest[1].value[1][0] << 5,pppEnvStPtr->m_stagePtr,
                                s_pppBreathModel_cpp_801db5a0,0x263);
      ...
      fVar4 = (float)pppMemAlloc__FUlPQ27CMemory6CStagePci
                               ((uint)*(ushort *)(param_2 + 0x12) * 0x5c,pppEnvStPtr->m_stagePtr,
                                s_pppBreathModel_cpp_801db5a0,0x269);
      dest[1].value[0][3] = fVar4;
      fVar4 = dest[1].value[0][3];
      if (fVar4 != 0.0) {
        memset(fVar4,0,(uint)*(ushort *)(param_2 + 0x12) * 0x5c);
        puVar8 = (undefined4 *)dest[1].value[0][3];
        for (iVar10 = 0; iVar10 < (int)(uint)*(ushort *)(param_2 + 0x12); iVar10 = iVar10 + 1) {
          uVar5 = pppMemAlloc__FUlPQ27CMemory6CStagePci
                            ((uint)*(ushort *)(param_2 + 0x10),pppEnvStPtr->m_stagePtr,
                             s_pppBreathModel_cpp_801db5a0,0x274);
          puVar8[1] = uVar5;
          memset(puVar8[1],0xffffffff,*(undefined2 *)(param_2 + 0x10));
          uVar5 = pppMemAlloc__FUlPQ27CMemory6CStagePci
                            ((uint)*(ushort *)(param_2 + 0x10),pppEnvStPtr->m_stagePtr,
                             s_pppBreathModel_cpp_801db5a0,0x277);
          puVar8[2] = uVar5;
          memset(puVar8[2],0xffffffff,*(undefined2 *)(param_2 + 0x10));
          *puVar8 = 0;
          puVar8 = puVar8 + 0x17;
        }
      }
      fVar11 = FLOAT_80330f80;
      fVar4 = FLOAT_80330f70;
      inVec = (Vec *)(dest[1].value[1] + 2);
      dest[1].value[1][2] = FLOAT_80330f70;
    ...
    UpdateAllParticle__FP11_pppPObjectP12VBreathModelP12PBreathModelP6VColor
              (&pppBreathModel->field0_0x0,dest,param_2,
               (undefined *)((int)(&pppBreathModel->field0_0x0 + 2) + iVar3));
    fVar4 = dest[1].value[0][1];
    fVar11 = dest[1].value[0][3];
    for (iVar3 = 0; iVar3 < (int)(uint)*(ushort *)(param_2 + 0x12); iVar3 = iVar3 + 1) {
...
LAB_800db990:
      if (bVar1) {
        ...
        PSMTXConcat(a,&(pppBreathModel->field0_0x0).m_localMatrix,&MStack_90);
        ...
        pStack_c0.value[0][3] = FLOAT_80330f70;
        pStack_c0.value[1][3] = FLOAT_80330f70;
        pStack_c0.value[2][3] = FLOAT_80330f70;
