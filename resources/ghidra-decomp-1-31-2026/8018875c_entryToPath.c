...

{
  ...
  if (param_1 == 0) {
    ...
    iVar1 = *(int *)(DAT_8032f064 + 4 + param_1 * 0xc);
    pcVar5 = (char *)(DAT_8032f068 + (*(uint *)(DAT_8032f064 + param_1 * 0xc) & 0xffffff));
    if (iVar1 == 0) {
      iVar1 = 0;
    }
    else {
      iVar1 = iVar1 * 0xc;
      pcVar4 = (char *)(DAT_8032f068 + (*(uint *)(DAT_8032f064 + iVar1) & 0xffffff));
      iVar1 = entryToPath(*(undefined4 *)(DAT_8032f064 + 4 + iVar1),param_2,param_3);
      if (iVar1 != param_3) {
        iVar2 = iVar1 + 1;
