...
STATIC_ASSERT(sizeof(YmLaserMapCylinderRaw) == sizeof(CMapCylinder));
STATIC_ASSERT(offsetof(YmLaserMapCylinderRaw, m_boundsMin) == 0x28);
STATIC_ASSERT(offsetof(YmLaserMapCylinderRaw, m_boundsMax) == 0x34);
