// Function: pppCacheDumpShapeTexture__FP10pppShapeStP12CMaterialSet
// Entry: 8006580c
// Size: 240 bytes

void pppCacheDumpShapeTexture__FP10pppShapeStP12CMaterialSet
...

{
  ...
  do {
    if (*pcVar9 != '\0') {
      CacheDumpTexture__12CMaterialSetFiP13CAmemCacheSet(materialSet,uVar7,CAMemCacheSet);
    }
    uVar7 = uVar7 + 1;
    pcVar9 = pcVar9 + 1;
  } while (uVar7 < 0x100);
