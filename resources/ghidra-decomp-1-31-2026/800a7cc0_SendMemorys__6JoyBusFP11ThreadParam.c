// Function: SendMemorys__6JoyBusFP11ThreadParam
// Entry: 800a7cc0
// Size: 268 bytes

undefined4 SendMemorys__6JoyBusFP11ThreadParam(JoyBus *joyBus,ThreadParam *threadParam)

{
  ...
  uVar2 = GetMemorys__8GbaQueueFi(&GbaQue,threadParam->m_portIndex);
  local_18 = (uint)CONCAT21(0x1413,uVar2) << 8;
