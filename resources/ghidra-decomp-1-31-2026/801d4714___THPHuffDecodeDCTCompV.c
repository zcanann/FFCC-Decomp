// Function: __THPHuffDecodeDCTCompV
// Entry: 801d4714
// Size: 1704 bytes

void __THPHuffDecodeDCTCompV(int param_1,short *param_2)

{
  ...
  iVar8 = DAT_8032f520 + 0x20;
  uVar9 = *(uint *)(param_1 + 0x6a0);
  uVar7 = iVar10 + 4U & 0x1f;
  uVar7 = (uVar9 << uVar7 | uVar9 >> 0x20 - uVar7) & 0x1f;
  if (iVar10 < 0x1d) {
    uVar3 = (uint)*(byte *)(DAT_8032f520 + uVar7);
    if (uVar3 == 0xff) {
      uVar3 = iVar10 + 5;
      iVar8 = 5;
      piVar5 = (int *)(DAT_8032f520 + 0x58);
LAB_801d4774:
      if (uVar3 != 0x21) goto code_r0x801d4780;
      uVar3 = 1;
...
LAB_801d47e4:
  ...
  if (iVar10 == 0x21) {
    ...
    *(int *)(param_1 + 0x6a4) = iVar12 + 2;
    ...
    if (iVar10 != 0x20) {
      uVar3 = (uint)*(byte *)(DAT_8032f520 + (uVar7 & 0x1f));
    ...
    *(uint *)(param_1 + 0x6a4) = (uint)bVar2;
    if (uVar3 != 0xff) goto LAB_801d49a8;
...
LAB_801d49a8:
  ...
  *param_2 = sVar6;
  do {
    ...
    iVar10 = DAT_8032f580 + 0x20;
    uVar9 = *(uint *)(param_1 + 0x6a0);
    uVar7 = iVar12 + 4U & 0x1f;
    uVar7 = (uVar9 << uVar7 | uVar9 >> 0x20 - uVar7) & 0x1f;
    if (iVar12 < 0x1d) {
      uVar3 = (uint)*(byte *)(DAT_8032f580 + uVar7);
      if (uVar3 == 0xff) {
        uVar3 = iVar12 + 5;
        iVar10 = 5;
        piVar5 = (int *)(DAT_8032f580 + 0x58);
LAB_801d4abc:
        if (uVar3 != 0x21) goto code_r0x801d4ac8;
        uVar3 = 1;
        puVar1 = (uint *)(*(int *)(param_1 + 0x69c) + 4);
        uVar9 = *puVar1;
        piVar5 = piVar5 + 1;
...
LAB_801d4bec:
      ...
      if (iVar12 == 0x20) {
        ...
        *(uint *)(param_1 + 0x6a4) = (uint)bVar2;
        ...
        uVar3 = (uint)*(byte *)(DAT_8032f580 + (uVar7 & 0x1f));
...
LAB_801d4cf0:
    ...
    if (uVar7 == 0) {
      ...
      param_2[(byte)(&DAT_801e8110)[iVar4]] = (short)uVar9;
    }
    iVar4 = iVar4 + 1;
  } while( true );
code_r0x801d4780:
  ...
  uVar3 = uVar3 + 1;
  iVar8 = iVar8 + 1;
  if ((int)uVar7 <= *piVar5) goto LAB_801d47e4;
  goto LAB_801d4774;
code_r0x801d4ac8:
  piVar5 = piVar5 + 1;
  uVar7 = uVar7 << 1 | (uVar9 << (uVar3 & 0x1f) | uVar9 >> 0x20 - (uVar3 & 0x1f)) & 1;
  uVar3 = uVar3 + 1;
  iVar10 = iVar10 + 1;
  if ((int)uVar7 <= *piVar5) goto LAB_801d4b2c;
  goto LAB_801d4abc;
}
