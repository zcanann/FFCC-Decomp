// Function: SetMaterialMenu__12CMaterialManFP12CMaterialSetii
// Entry: 8003eba0
// Size: 1244 bytes

void SetMaterialMenu__12CMaterialManFP12CMaterialSetii
...

{
  ...
  *(undefined4 *)&materialMan->field_0x48 = *(undefined4 *)&materialMan->field_0x40;
  ...
  uVar2 = *(uint *)&materialMan->field_0x48 & *(uint *)(iVar1 + 0x24);
  if (*(uint *)&materialMan->field_0x44 == uVar2) {
    if ((uVar2 & 0x200) != 0) {
    ...
    *(uint *)&materialMan->field_0x44 = uVar2;
