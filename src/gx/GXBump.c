...
void GXSetIndTexCoordScale(GXIndTexStageID ind_state, GXIndTexScale scale_s, GXIndTexScale scale_t) {
    ...
    case GX_INDTEXSTAGE0:
        gx->IndTexScale0 = (gx->IndTexScale0 & 0xFFFFFFF0) | (u32)scale_s;
        gx->IndTexScale0 = (gx->IndTexScale0 & 0xFFFFFF0F) | ((u32)scale_t << 4);
        gx->IndTexScale0 = (gx->IndTexScale0 & 0x00FFFFFF) | 0x25000000;
        GX_WRITE_SOME_REG5(GX_LOAD_BP_REG, gx->IndTexScale0);
        break;
    case GX_INDTEXSTAGE1:
        gx->IndTexScale0 = (gx->IndTexScale0 & 0xFFFFF0FF) | ((u32)scale_s << 8);
        gx->IndTexScale0 = (gx->IndTexScale0 & 0xFFFF0FFF) | ((u32)scale_t << 12);
        gx->IndTexScale0 = (gx->IndTexScale0 & 0x00FFFFFF) | 0x25000000;
        GX_WRITE_SOME_REG5(GX_LOAD_BP_REG, gx->IndTexScale0);
        break;
    case GX_INDTEXSTAGE2:
        gx->IndTexScale1 = (gx->IndTexScale1 & 0xFFFFFFF0) | (u32)scale_s;
        gx->IndTexScale1 = (gx->IndTexScale1 & 0xFFFFFF0F) | ((u32)scale_t << 4);
        gx->IndTexScale1 = (gx->IndTexScale1 & 0x00FFFFFF) | 0x26000000;
        GX_WRITE_SOME_REG5(GX_LOAD_BP_REG, gx->IndTexScale1);
        break;
    case GX_INDTEXSTAGE3:
        gx->IndTexScale1 = (gx->IndTexScale1 & 0xFFFFF0FF) | ((u32)scale_s << 8);
        gx->IndTexScale1 = (gx->IndTexScale1 & 0xFFFF0FFF) | ((u32)scale_t << 12);
        gx->IndTexScale1 = (gx->IndTexScale1 & 0x00FFFFFF) | 0x26000000;
        GX_WRITE_SOME_REG5(GX_LOAD_BP_REG, gx->IndTexScale1);
        break;
    default:
...
void GXSetIndTexOrder(GXIndTexStageID ind_stage, GXTexCoordID tex_coord, GXTexMapID tex_map) {
    ...
    switch (ind_stage) {
    case GX_INDTEXSTAGE0:
        gx->iref = (gx->iref & 0xFFFFFFF8) | (u32)tex_map;
        gx->iref = (gx->iref & 0xFFFFFFC7) | ((u32)tex_coord << 3);
        break;
    case GX_INDTEXSTAGE1:
        gx->iref = (gx->iref & 0xFFFFFE3F) | ((u32)tex_map << 6);
        gx->iref = (gx->iref & 0xFFFFF1FF) | ((u32)tex_coord << 9);
        break;
    case GX_INDTEXSTAGE2:
        gx->iref = (gx->iref & 0xFFFF8FFF) | ((u32)tex_map << 12);
        gx->iref = (gx->iref & 0xFFFC7FFF) | ((u32)tex_coord << 15);
        break;
    case GX_INDTEXSTAGE3:
        gx->iref = (gx->iref & 0xFFE3FFFF) | ((u32)tex_map << 18);
        gx->iref = (gx->iref & 0xFF1FFFFF) | ((u32)tex_coord << 21);
        break;
    default:
...
void __GXUpdateBPMask(void) {
    ...
    if (((gx->bpMask & 0xFF) == mask)) {
        return;
    }

    gx->bpMask = (gx->bpMask & 0xFFFFFF00) | mask;
...
const f32 GXIndTexMtxScale1024[2] = {
    1024.0f,
    0.0f,
};
