...
enum RedStreamFileLayoutOffset {
    REDSOUND_STREAM_FILE_HEAD_OFFSET = 0,
    REDSOUND_STREAM_FILE_ADPCM_OFFSET = REDSOUND_STREAM_FILE_HEAD_OFFSET + REDSOUND_STREAM_HEAD_SIZE,
    ...
    REDSOUND_STREAM_FILE_TRAILING_PAD_SIZE = REDSOUND_STREAM_FILE_AUDIO_OFFSET - REDSOUND_STREAM_FILE_TRAILING_PAD_OFFSET,
