...
{
    unsigned int offset = reinterpret_cast<unsigned int>(ptr);
    ptr = reinterpret_cast<void*>(offset + reinterpret_cast<unsigned int>(base));
}

static inline void AddMeshDataBase(CMapMeshUvPair*& ptr, void* base)
{
    unsigned int offset = reinterpret_cast<unsigned int>(ptr);
    ptr = reinterpret_cast<CMapMeshUvPair*>(offset + reinterpret_cast<unsigned int>(base));
}

static inline void AddMeshDataBase(CMapMeshDrawEntry*& ptr, void* base)
{
    unsigned int offset = reinterpret_cast<unsigned int>(ptr);
    ptr = reinterpret_cast<CMapMeshDrawEntry*>(offset + reinterpret_cast<unsigned int>(base));
}
...
void CMapMesh::Off2Ptr()
{
    ...
    int offset = 0;
    for (int i = 0; i < static_cast<int>(m_displayListCount); i++) {
        CMapMeshDrawEntry* entry = reinterpret_cast<CMapMeshDrawEntry*>(reinterpret_cast<u8*>(m_drawEntries) + offset);
        offset += 0x10;
