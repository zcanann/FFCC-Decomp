...
static inline MatrixXZYDataOffsets* GetMatrixXZYDataOffsets(_pppCtrlTable* ctrl)
{
    return reinterpret_cast<MatrixXZYDataOffsets*>(ctrl->m_serializedDataOffsets);
}
...
{
    (void)stepData;
    MatrixXZYDataOffsets* offsets = GetMatrixXZYDataOffsets(param);
