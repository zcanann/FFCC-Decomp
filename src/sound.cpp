...
{
    SePause__9CRedSoundFii(RedSound(this), -1, ((0u - (u32)pause) | (u32)pause) >> 31);
    StreamPause__9CRedSoundFii(RedSound(this), -1, ((0u - (u32)pause) | (u32)pause) >> 31);
    reinterpret_cast<CSoundLayout*>(this)->m_pauseAllSe = pause;
}
