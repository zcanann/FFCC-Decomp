// Function: setSize__29CPtrArray<P15CMapLightHolder>FUl
// Entry: 80033de8
// Size: 240 bytes

undefined4 setSize__29CPtrArray<P15CMapLightHolder>FUl(CPtrArray *ptrArray,uint size)
  ...
  if (ptrArray->size < size) {
    if (ptrArray->size == 0) {
      ...
      if (ptrArray->growCapacity == 0) {
        Printf__7CSystemFPce(&System,&DAT_801d7620);
      }
    ...
    dstBuffer = (void **)_Alloc__7CMemoryFUlPQ27CMemory6CStagePcii
                                   (&Memory,ptrArray->size << 2,ptrArray->stage,
                                    s_collection_ptrarray_h_801d763c,0xfa,0);
