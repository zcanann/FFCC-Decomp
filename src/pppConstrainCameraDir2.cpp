...
extern "C" void CalcGraphValue__FP11_pppPObjectlRfRfRffRfRf(void*, int, float*, float*, float*, float, float*, float*);
                                 ...
                                 _pppCtrlTable* param_3)
{
    ...
    if (gPppCalcDisabled == 0) {
        ...
        CalcGraphValue__FP11_pppPObjectlRfRfRffRfRf(
            param_1, param_2->m_graphId, value, value + 1, value + 2, param_2->m_dataValIndex, &param_2->m_initWOrk,
            &param_2->m_stepValue);
