...
void __THPHuffDecodeDCTCompY(int param_1,short *param_2)

{
  ...
  iVar7 = DAT_8032f4e0 + 0x20;
  uVar10 = *(uint *)(param_1 + 0x6a0);
  uVar6 = iVar11 + 4U & 0x1f;
  uVar6 = (uVar10 << uVar6 | uVar10 >> 0x20 - uVar6) & 0x1f;
  if (iVar11 < 0x1d) {
    uVar3 = (uint)*(byte *)(DAT_8032f4e0 + uVar6);
    if (uVar3 == 0xff) {
      uVar3 = iVar11 + 5;
      iVar7 = 5;
      piVar8 = (int *)(DAT_8032f4e0 + 0x58);
LAB_801d3a54:
      if (uVar3 != 0x21) goto code_r0x801d3a60;
      uVar3 = 1;
...
LAB_801d3ac4:
  ...
  if (iVar11 == 0x21) {
    ...
    *(int *)(param_1 + 0x6a4) = iVar9 + 2;
    ...
    if (iVar11 != 0x20) {
      uVar3 = (uint)*(byte *)(DAT_8032f4e0 + (uVar6 & 0x1f));
    ...
    *(uint *)(param_1 + 0x6a4) = (uint)bVar2;
    if (uVar3 != 0xff) goto LAB_801d3c88;
  ...
  for (iVar7 = 1; uVar3 = uVar6, iVar7 < 0x40; iVar7 = iVar7 + 1) {
    ...
    if ((int)uVar6 < 0x1d) {
      ...
      if (uVar14 == 0xff) {
        ...
        piVar8 = (int *)(iVar4 + 0x58);
LAB_801d3d98:
        if (uVar3 != 0x21) goto code_r0x801d3da4;
        uVar3 = 1;
        puVar1 = (uint *)(*(int *)(param_1 + 0x69c) + 4);
        uVar10 = *puVar1;
        piVar8 = piVar8 + 1;
...
LAB_801d3fa8:
    ...
    if (uVar6 == 0) {
      ...
      param_2[(byte)(&DAT_801e8110)[iVar7]] = (short)uVar12;
    }
    uVar6 = uVar3;
  }
  *(uint *)(param_1 + 0x6a4) = uVar3;
...
code_r0x801d3a60:
  ...
  uVar3 = uVar3 + 1;
  iVar7 = iVar7 + 1;
  if ((int)uVar6 <= *piVar8) goto LAB_801d3ac4;
  goto LAB_801d3a54;
code_r0x801d3da4:
  piVar8 = piVar8 + 1;
  uVar12 = uVar12 << 1 | (uVar10 << (uVar3 & 0x1f) | uVar10 >> 0x20 - (uVar3 & 0x1f)) & 1;
  uVar3 = uVar3 + 1;
  iVar9 = iVar9 + 1;
  if ((int)uVar12 <= *piVar8) goto LAB_801d3e04;
  goto LAB_801d3d98;
}
