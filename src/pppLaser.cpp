...
STATIC_ASSERT(sizeof(pppLaserCylinder) == sizeof(CMapCylinder));
STATIC_ASSERT(offsetof(pppLaserCylinder, m_bound) == offsetof(CMapCylinder, m_bound));
