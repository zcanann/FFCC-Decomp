...
STATIC_ASSERT(sizeof(CheckBGHeightCylinder) == sizeof(CMapCylinder));
STATIC_ASSERT(offsetof(CheckBGHeightCylinder, m_boundsMin) == offsetof(CMapCylinder, m_boundsMin));
