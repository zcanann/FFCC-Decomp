// Function: SendCompatibility__6JoyBusFP11ThreadParam
// Entry: 800aa440
// Size: 704 bytes

/* WARNING: Removing unreachable block (ram,0x800aa478) */

JoyBus * SendCompatibility__6JoyBusFP11ThreadParam(JoyBus *joyBus,ThreadParam *threadParam)

{
  ...
  if (threadParam->m_subState == '\x01') {
    ...
    if (threadParam->m_subState == '\0') {
      ...
      local_118 = 5;
      iVar1 = GetCompatibility__8GbaQueueFiPUc(&GbaQue,threadParam->m_portIndex,acStack_117);
      pJVar2 = (JoyBus *)
