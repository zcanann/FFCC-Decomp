// Function: RedDelete__Fi
// Entry: 801c00e8
// Size: 216 bytes

void RedDelete__Fi(int param_1)

{
  ...
  if (param_1 != 0) {
    ...
    dstBuffer = DAT_8032f4a0;
    if (DAT_8032f4a0 != (int *)0x0) {
      while( true ) {
        if ((dstBuffer[1] == 0) || (DAT_8032f4a0 + 0x800 <= dstBuffer)) goto LAB_801c0198;
        if (*dstBuffer == param_1) break;
        dstBuffer = dstBuffer + 2;
      }
      uVar1 = (int)DAT_8032f4a0 + (0x2000 - (int)(dstBuffer + 2));
