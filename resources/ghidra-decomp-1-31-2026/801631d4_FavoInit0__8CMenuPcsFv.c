// Function: FavoInit0__8CMenuPcsFv
// Entry: 801631d4
// Size: 616 bytes

void FavoInit0__8CMenuPcsFv(CMenuPcs *menuPcs)

{
  ...
  *(undefined4 *)(iVar2 + 0x2f0) = 5;
  iVar2 = *(int *)&menuPcs->field_0x850;
  *(undefined4 *)(iVar2 + 0x334) = 2;
  *(undefined4 *)(iVar2 + 0x32c) = 0;
  *(undefined4 *)(iVar2 + 0x330) = 5;
  iVar2 = *(int *)&menuPcs->field_0x850;
  *(undefined4 *)(iVar2 + 0x374) = 2;
  *(undefined4 *)(iVar2 + 0x36c) = 0;
  *(undefined4 *)(iVar2 + 0x370) = 5;
