...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "p_dbgmenu.cpp", extra_cflags=["-sdata 8", "-inline auto,deferred"]),
            ...
            Object(NonMatching, "p_map.cpp", extra_cflags=["-sdata 8", "-inline auto,deferred"]),
            Object(NonMatching, "p_MaterialEditor.cpp", extra_cflags=["-sdata 8"]),
            Object(NonMatching, "p_mc.cpp", extra_cflags=["-sdata 8"]),
            Object(NonMatching, "p_menu.cpp", extra_cflags=["-sdata 8"]),
            Object(NonMatching, "p_minigame.cpp", extra_cflags=["-sdata 8", "-common off"]),
            ...
            Object(NonMatching, "p_system.cpp", extra_cflags=["-sdata 8", "-str reuse,readonly"]),
            ...
            Object(NonMatching, "util.cpp", extra_cflags=["-RTTI on"]),
