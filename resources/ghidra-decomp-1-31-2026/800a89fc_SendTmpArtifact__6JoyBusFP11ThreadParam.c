// Function: SendTmpArtifact__6JoyBusFP11ThreadParam
// Entry: 800a89fc
// Size: 704 bytes

/* WARNING: Removing unreachable block (ram,0x800a8a34) */

JoyBus * SendTmpArtifact__6JoyBusFP11ThreadParam(JoyBus *joyBus,ThreadParam *threadParam)

{
  ...
  if (threadParam->m_subState == '\x01') {
    ...
    if (threadParam->m_subState == '\0') {
      ...
      local_118 = 9;
      iVar1 = GetTmpArtifactData__8GbaQueueFiPUc(&GbaQue,threadParam->m_portIndex,auStack_117);
      pJVar2 = (JoyBus *)
               MakeJoyData__6JoyBusFPciPUi
                         (joyBus,&local_118,iVar1 + 1,
