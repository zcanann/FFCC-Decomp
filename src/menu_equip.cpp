	...
	if (mode == 1) {
		...
		for (int i = 0; (i < 8) && (i + *(s16*)(menuState + 0x34) < letter[0]); i++) {
			...
			if ((idx > 0) && (letter[idx] >= 0)) {
				...
				int itemIdx = *(s16*)(caravanWork + letter[idx] * 2 + 0xb6);
				DrawSingleIcon__8CMenuPcsFiiifif((double)*(float*)(listStart + 8), this, itemIdx, iconX, iconY, 0.0f);
			}
			iconItem += 0x20;
		}
	}
...
void CMenuPcs::EquipInit1()
{
	...
	*(float*)(psVar10 + 10) = fVar3;
	...
	puVar12 = (short*)(GetEquipListBase(this) + (iVar8 + 1) * 0x40 + 8);
	...
	*(int*)(puVar12 + 0x14) = 5;
	...
	puVar12 = (short*)(GetEquipListBase(this) + (iVar8 + 2) * 0x40 + 8);
	*(int*)(puVar12 + 0xe) = 0x2f;
	puVar12[2] = 0x30;
	puVar12[3] = 0x30;
	*puVar12 = 0xa5;
	...
	*(int*)(puVar12 + 0x14) = 5;
	...
	puVar12 = (short*)(GetEquipListBase(this) + (iVar8 + 3) * 0x40 + 8);
	*(int*)(puVar12 + 0x16) = 2;
	...
	*(int*)(puVar12 + 0x14) = 5;
	...
	psVar10 = GetEquipList(this) + *GetEquipList(this) * 0x20 + 4;
	iVar8 = 4;
	do {
		psVar13 = (short*)(GetEquipListBase(this) + iVar11 + 8);
		psVar13[0x16] = 0;
		psVar13[0x17] = 2;
		psVar13[0xe] = 0;
		psVar13[0xf] = 0x37;
		...
		*(float*)(psVar13 + 6) = fVar2;
		...
		iVar14 = iVar11 + 0x48;
		iVar11 = iVar11 + 0x80;
		psVar13 = (short*)(GetEquipListBase(this) + iVar14);
		psVar13[0x16] = 0;
		psVar13[0x17] = 2;
		psVar13[0xe] = 0;
		psVar13[0xf] = 0x37;
	...
	*(short*)(GetEquipListBase(this) + 2) = (short)iVar9;
