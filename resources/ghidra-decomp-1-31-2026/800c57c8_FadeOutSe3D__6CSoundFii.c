// Function: FadeOutSe3D__6CSoundFii
// Entry: 800c57c8
// Size: 288 bytes

void FadeOutSe3D__6CSoundFii(CSound *sound,int param_2,int param_3)
...
LAB_800c588c:
    if (pbVar3 != (byte *)0x0) {
      if (*(int *)(pbVar3 + 8) < 0) {
        Printf__7CSystemFPce(&System,s_Sound___1_n_B_801db130,param_3,iVar1);
      }
      else {
        SeFadeOut__9CRedSoundFii(&sound->m_redSound,*(int *)(pbVar3 + 8),param_3);
      }
      *pbVar3 = *pbVar3 & 0x7f;
    }
  }
