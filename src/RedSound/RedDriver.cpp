...
struct RedDriverSyncState {
    RedDmaRequest m_DmaControl[REDSOUND_DMA_CONTROL_ENTRY_COUNT];
...
enum RedDriverSyncLayoutOffset {
    REDSOUND_DRIVER_SYNC_DMA_QUEUE_OFFSET = (unsigned int)&(((RedDriverSyncState*)0)->m_DmaControl),
    REDSOUND_DRIVER_SYNC_STREAM_DMA_QUEUE_OFFSET =
        REDSOUND_DRIVER_SYNC_DMA_QUEUE_OFFSET + REDSOUND_DMA_QUEUE_SIZE,
    ...
    REDSOUND_DRIVER_SYNC_WAVE_THREAD_OFFSET = (unsigned int)&(((RedDriverSyncState*)0)->m_WaveSettingThread),
    REDSOUND_DRIVER_SYNC_WAVE_SEMAPHORE_OFFSET = (unsigned int)&(((RedDriverSyncState*)0)->m_WaveSettingSemaphore),
    ...
    REDSOUND_DRIVER_SYNC_DMA_THREAD_OFFSET = (unsigned int)&(((RedDriverSyncState*)0)->m_DmaExecuteThread),
    REDSOUND_DRIVER_SYNC_DMA_SEMAPHORE_OFFSET = (unsigned int)&(((RedDriverSyncState*)0)->m_DmaExecuteSemaphore),
    ...
    REDSOUND_DRIVER_SYNC_MUSIC_THREAD_OFFSET = (unsigned int)&(((RedDriverSyncState*)0)->m_MusicSkipThread),
    REDSOUND_DRIVER_SYNC_MUSIC_SEMAPHORE_OFFSET = (unsigned int)&(((RedDriverSyncState*)0)->m_MusicSkipSemaphore),
    REDSOUND_DRIVER_SYNC_SIZE = sizeof(RedDriverSyncState),
    REDSOUND_DRIVER_BSS_SE_BLOCK_DATA_OFFSET = REDSOUND_DRIVER_SYNC_SIZE,
    REDSOUND_DRIVER_BSS_RED_MEMORY_DTOR_CHAIN_OFFSET =
        REDSOUND_DRIVER_BSS_SE_BLOCK_DATA_OFFSET + REDSOUND_SE_BLOCK_BANK_COUNT * sizeof(RedSeBlockHEAD*),
    REDSOUND_DRIVER_BSS_DTOR_CHAIN_SIZE = sizeof(DestructorChain),
    REDSOUND_DRIVER_BSS_RED_ENTRY_DTOR_CHAIN_OFFSET =
        REDSOUND_DRIVER_BSS_RED_MEMORY_DTOR_CHAIN_OFFSET + REDSOUND_DRIVER_BSS_DTOR_CHAIN_SIZE,
    REDSOUND_DRIVER_BSS_ENTRY_OFFSET =
        REDSOUND_DRIVER_BSS_RED_ENTRY_DTOR_CHAIN_OFFSET + REDSOUND_DRIVER_BSS_DTOR_CHAIN_SIZE,
    REDSOUND_DRIVER_BSS_SIZE = REDSOUND_DRIVER_BSS_ENTRY_OFFSET + sizeof(CRedEntry),
};

enum RedDriverBssMapOffset {
    REDSOUND_DRIVER_MAP_BSS_DMA_QUEUE_OFFSET = 0x0000,
    REDSOUND_DRIVER_MAP_BSS_MAIN_THREAD_OFFSET = 0x1C00,
    REDSOUND_DRIVER_MAP_BSS_MAIN_SEMAPHORE_OFFSET = 0x1F18,
    REDSOUND_DRIVER_MAP_BSS_MAIN_THREAD_PAD_OFFSET = 0x1F24,
    REDSOUND_DRIVER_MAP_BSS_WAVE_THREAD_OFFSET = 0x1F28,
    REDSOUND_DRIVER_MAP_BSS_WAVE_SEMAPHORE_OFFSET = 0x2240,
    REDSOUND_DRIVER_MAP_BSS_WAVE_DATA_OFFSET = 0x224C,
    REDSOUND_DRIVER_MAP_BSS_WAVE_THREAD_PAD_OFFSET = 0x225C,
    REDSOUND_DRIVER_MAP_BSS_DMA_THREAD_OFFSET = 0x2260,
    REDSOUND_DRIVER_MAP_BSS_DMA_SEMAPHORE_OFFSET = 0x2578,
    REDSOUND_DRIVER_MAP_BSS_DMA_REQUEST_OFFSET = 0x2584,
    REDSOUND_DRIVER_MAP_BSS_DMA_THREAD_PAD_OFFSET = 0x25A4,
    REDSOUND_DRIVER_MAP_BSS_MUSIC_THREAD_OFFSET = 0x25A8,
    REDSOUND_DRIVER_MAP_BSS_MUSIC_SEMAPHORE_OFFSET = 0x28C0,
};
...
struct RedDriverSmallDataPrefixState {
    ...
    int m_SoundMode;
    RedTickHistory* volatile p_Tick;
    u8* volatile p_ZeroData;
    RedExecCommand* volatile p_ExecCommand;
    RedExecCommand* volatile p_ExecCommandNow;
    RedExecCommand* volatile p_ExecCommandOld;
    RedDmaRequest* volatile p_DmaControlNow[REDSOUND_DMA_QUEUE_COUNT];
    RedDmaRequest* volatile p_DmaControlOld[REDSOUND_DMA_QUEUE_COUNT];
    ...
    u8* volatile p_WaveSettingThreadStack;
    int m_WaveSettingStatus;
    u8* volatile p_DmaExecuteThreadStack;
...
enum RedDriverSmallDataLayout {
    ...
    REDSOUND_DRIVER_SBSS_TICK_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_Tick),
    REDSOUND_DRIVER_SBSS_ZERO_DATA_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_ZeroData),
    REDSOUND_DRIVER_SBSS_EXEC_COMMAND_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_ExecCommand),
    REDSOUND_DRIVER_SBSS_EXEC_COMMAND_NOW_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_ExecCommandNow),
    REDSOUND_DRIVER_SBSS_EXEC_COMMAND_OLD_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_ExecCommandOld),
    REDSOUND_DRIVER_SBSS_DMA_NOW_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_DmaControlNow),
    REDSOUND_DRIVER_SBSS_DMA_OLD_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_DmaControlOld),
    REDSOUND_DRIVER_SBSS_SOUND_CONTROL_BUFFER_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_SoundControlBuffer),
    REDSOUND_DRIVER_SBSS_SOUND_CONTROL_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_SoundControl),
    REDSOUND_DRIVER_SBSS_KEY_ON_ENTRY_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->m_KeyOnEntry),
    REDSOUND_DRIVER_SBSS_KEY_ON_DATA_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_KeyOnData),
    ...
    REDSOUND_DRIVER_SBSS_MUSIC_REPLAY_POINT_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_MusicReplayPoint),
    REDSOUND_DRIVER_SBSS_MUSIC_TEMPO_CONTROL_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_MusicTempoControl),
    REDSOUND_DRIVER_SBSS_MUSIC_PITCH_CONTROL_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_MusicPitchControl),
    ...
    REDSOUND_DRIVER_SBSS_MUSIC_NEXT_PLAY_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_MusicNextPlay),
    ...
    REDSOUND_DRIVER_SBSS_STREAM_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_Stream),
    ...
    REDSOUND_DRIVER_SBSS_VOICE_DATA_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_VoiceData),
    REDSOUND_DRIVER_SBSS_EDITOR_VOICE_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_EditorVoice),
    REDSOUND_DRIVER_SBSS_EDITOR_TRACK_OFFSET = (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_EditorTrack),
    REDSOUND_DRIVER_SBSS_MAIN_THREAD_STACK_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_MainThreadStack),
    ...
    REDSOUND_DRIVER_SBSS_WAVE_THREAD_STACK_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_WaveSettingThreadStack),
    ...
    REDSOUND_DRIVER_SBSS_DMA_THREAD_STACK_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_DmaExecuteThreadStack),
    ...
    REDSOUND_DRIVER_SBSS_MUSIC_THREAD_STACK_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_MusicSkipThreadStack),
    ...
    REDSOUND_DRIVER_SBSS_REVERB_DEPTH_OFFSET =
        (unsigned int)&(((RedDriverSmallDataPrefixState*)0)->p_ReverbDepth),
    ...
    REDSOUND_DRIVER_SBSS_SILENT_WAVE_OFFSET = REDSOUND_DRIVER_SBSS_DMA_IN_THREAD_OFFSET + sizeof(int),
    REDSOUND_DRIVER_SBSS_SILENT_WAVE_SIZE = sizeof(int),
    REDSOUND_DRIVER_SBSS_SIZE =
        REDSOUND_DRIVER_SBSS_SILENT_WAVE_OFFSET + REDSOUND_DRIVER_SBSS_SILENT_WAVE_SIZE,
};

enum RedDriverSmallDataMapOffset {
    REDSOUND_DRIVER_MAP_SBSS_MASTER_TIME_OFFSET = 0x00,
    REDSOUND_DRIVER_MAP_SBSS_SEQUENCIAL_ID_OFFSET = 0x04,
    REDSOUND_DRIVER_MAP_SBSS_THREAD_CONTROL_OFFSET = 0x08,
    REDSOUND_DRIVER_MAP_SBSS_THREAD_EXECUTE_OFFSET = 0x0C,
    REDSOUND_DRIVER_MAP_SBSS_SOUND_MODE_OFFSET = 0x10,
    REDSOUND_DRIVER_MAP_SBSS_TICK_OFFSET = 0x14,
    REDSOUND_DRIVER_MAP_SBSS_ZERO_DATA_OFFSET = 0x18,
    REDSOUND_DRIVER_MAP_SBSS_EXEC_COMMAND_OFFSET = 0x1C,
    REDSOUND_DRIVER_MAP_SBSS_EXEC_COMMAND_NOW_OFFSET = 0x20,
    REDSOUND_DRIVER_MAP_SBSS_EXEC_COMMAND_OLD_OFFSET = 0x24,
    REDSOUND_DRIVER_MAP_SBSS_DMA_NOW_OFFSET = 0x28,
    REDSOUND_DRIVER_MAP_SBSS_DMA_OLD_OFFSET = 0x30,
    REDSOUND_DRIVER_MAP_SBSS_SOUND_CONTROL_BUFFER_OFFSET = 0x38,
    REDSOUND_DRIVER_MAP_SBSS_SOUND_CONTROL_OFFSET = 0x3C,
    REDSOUND_DRIVER_MAP_SBSS_KEY_ON_ENTRY_OFFSET = 0x40,
    REDSOUND_DRIVER_MAP_SBSS_KEY_ON_DATA_OFFSET = 0x44,
    REDSOUND_DRIVER_MAP_SBSS_SOUND_PLAY_MODE_OFFSET = 0x48,
    REDSOUND_DRIVER_MAP_SBSS_SOUND_MASTER_CONTROL_OFFSET = 0x4C,
    REDSOUND_DRIVER_MAP_SBSS_REPORT_PRINT_OFFSET = 0x50,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_FAST_SPEED_OFFSET = 0x54,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_SKIP_LINE_OFFSET = 0x58,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_KEY_SIGNATURE_OFFSET = 0x5C,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_REPLAY_POINT_OFFSET = 0x60,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_TEMPO_CONTROL_OFFSET = 0x64,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_PITCH_CONTROL_OFFSET = 0x68,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_PHRASE_STOP_OFFSET = 0x6C,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_NEXT_PLAY_OFFSET = 0x70,
    REDSOUND_DRIVER_MAP_SBSS_CROSS_TIME_OFFSET = 0x74,
    REDSOUND_DRIVER_MAP_SBSS_MASTER_MUSIC_VOLUME_OFFSET = 0x78,
    REDSOUND_DRIVER_MAP_SBSS_MASTER_SE_VOLUME_OFFSET = 0x7C,
    REDSOUND_DRIVER_MAP_SBSS_STREAM_OFFSET = 0x80,
    REDSOUND_DRIVER_MAP_SBSS_DMA_MODE_OFFSET = 0x84,
    REDSOUND_DRIVER_MAP_SBSS_SE_SKIP_STEP_OFFSET = 0x88,
    REDSOUND_DRIVER_MAP_SBSS_VOICE_DATA_OFFSET = 0x8C,
    REDSOUND_DRIVER_MAP_SBSS_EDITOR_VOICE_OFFSET = 0x90,
    REDSOUND_DRIVER_MAP_SBSS_EDITOR_TRACK_OFFSET = 0x98,
    REDSOUND_DRIVER_MAP_SBSS_MAIN_THREAD_STACK_OFFSET = 0x9C,
    REDSOUND_DRIVER_MAP_SBSS_MAIN_THREAD_TIME_OFFSET = 0xA0,
    REDSOUND_DRIVER_MAP_SBSS_WAVE_THREAD_STACK_OFFSET = 0xA4,
    REDSOUND_DRIVER_MAP_SBSS_WAVE_SETTING_STATUS_OFFSET = 0xA8,
    REDSOUND_DRIVER_MAP_SBSS_DMA_THREAD_STACK_OFFSET = 0xAC,
    REDSOUND_DRIVER_MAP_SBSS_DMA_STATUS_OFFSET = 0xB0,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_THREAD_STACK_OFFSET = 0xB4,
    REDSOUND_DRIVER_MAP_SBSS_MUSIC_SKIP_COMPLETE_OFFSET = 0xB8,
    REDSOUND_DRIVER_MAP_SBSS_REVERB_DEPTH_OFFSET = 0xBC,
    REDSOUND_DRIVER_MAP_SBSS_MUTE_OFFSET = 0xC0,
    REDSOUND_DRIVER_MAP_SBSS_RED_MEMORY_OFFSET = 0xC8,
    REDSOUND_DRIVER_MAP_SBSS_DMA_EXECUTE_OFFSET = 0xCC,
    REDSOUND_DRIVER_MAP_SBSS_DMA_IN_THREAD_OFFSET = 0xD0,
    REDSOUND_DRIVER_MAP_SBSS_SILENT_WAVE_OFFSET = 0xD4,
    REDSOUND_DRIVER_MAP_SBSS_SIZE = 0xD8,
};
...
enum RedDriverStringMapLayout {
    REDSOUND_DRIVER_MAP_RODATA_STRING_OFFSET = 0x00,
    REDSOUND_DRIVER_MAP_RODATA_STRING_SIZE = 0xFD,
    REDSOUND_DRIVER_MAP_SDATA2_STRING_OFFSET = 0x00,
    REDSOUND_DRIVER_MAP_SDATA2_STRING_SIZE = 0x0D,
};
...
struct RedDriverBssState {
    ...
    DestructorChain c_RedMemoryDtorChain;
    DestructorChain c_RedEntryDtorChain;
...
#define RedDmaRequestSetMainMemory(request, memory) ((request)->m_mainMemory = (void*)(memory))
...
#define RedDmaRequestGetMainMemory(request) ((int)(request)->m_mainMemory)
...
STATIC_ASSERT(offsetof(RedDriverSyncState, m_DmaControl) == REDSOUND_DRIVER_SYNC_DMA_QUEUE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_DMA_QUEUE_OFFSET == REDSOUND_DRIVER_MAP_BSS_DMA_QUEUE_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSyncState*)0)->m_DmaControl) == REDSOUND_DMA_CONTROL_SIZE);
...
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_MAIN_THREAD_OFFSET == REDSOUND_DRIVER_MAP_BSS_MAIN_THREAD_OFFSET);
...
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_MAIN_SEMAPHORE_OFFSET == REDSOUND_DRIVER_MAP_BSS_MAIN_SEMAPHORE_OFFSET);
...
STATIC_ASSERT(offsetof(RedDriverSyncState, m_mainThreadAlignPadding) ==
              REDSOUND_DRIVER_SYNC_MAIN_THREAD_PAD_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_MAIN_THREAD_PAD_OFFSET == REDSOUND_DRIVER_MAP_BSS_MAIN_THREAD_PAD_OFFSET);
...
STATIC_ASSERT(offsetof(RedDriverSyncState, m_WaveSettingThread) == REDSOUND_DRIVER_SYNC_WAVE_THREAD_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_WAVE_THREAD_OFFSET == REDSOUND_DRIVER_MAP_BSS_WAVE_THREAD_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSyncState*)0)->m_WaveSettingThread) == REDSOUND_DRIVER_SYNC_THREAD_SIZE);
STATIC_ASSERT(offsetof(RedDriverSyncState, m_WaveSettingSemaphore) == REDSOUND_DRIVER_SYNC_WAVE_SEMAPHORE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_WAVE_SEMAPHORE_OFFSET == REDSOUND_DRIVER_MAP_BSS_WAVE_SEMAPHORE_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSyncState*)0)->m_WaveSettingSemaphore) == REDSOUND_DRIVER_SYNC_SEMAPHORE_SIZE);
STATIC_ASSERT(offsetof(RedDriverSyncState, m_WaveSettingData) == REDSOUND_DRIVER_SYNC_WAVE_DATA_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_WAVE_DATA_OFFSET == REDSOUND_DRIVER_MAP_BSS_WAVE_DATA_OFFSET);
...
STATIC_ASSERT(offsetof(RedDriverSyncState, m_waveThreadAlignPadding) ==
              REDSOUND_DRIVER_SYNC_WAVE_THREAD_PAD_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_WAVE_THREAD_PAD_OFFSET == REDSOUND_DRIVER_MAP_BSS_WAVE_THREAD_PAD_OFFSET);
...
STATIC_ASSERT(offsetof(RedDriverSyncState, m_DmaExecuteThread) == REDSOUND_DRIVER_SYNC_DMA_THREAD_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_DMA_THREAD_OFFSET == REDSOUND_DRIVER_MAP_BSS_DMA_THREAD_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSyncState*)0)->m_DmaExecuteThread) == REDSOUND_DRIVER_SYNC_THREAD_SIZE);
STATIC_ASSERT(offsetof(RedDriverSyncState, m_DmaExecuteSemaphore) == REDSOUND_DRIVER_SYNC_DMA_SEMAPHORE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_DMA_SEMAPHORE_OFFSET == REDSOUND_DRIVER_MAP_BSS_DMA_SEMAPHORE_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSyncState*)0)->m_DmaExecuteSemaphore) == REDSOUND_DRIVER_SYNC_SEMAPHORE_SIZE);
STATIC_ASSERT(offsetof(RedDriverSyncState, m_DMARequest) == REDSOUND_DRIVER_SYNC_DMA_REQUEST_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_DMA_REQUEST_OFFSET == REDSOUND_DRIVER_MAP_BSS_DMA_REQUEST_OFFSET);
...
STATIC_ASSERT(offsetof(RedDriverSyncState, m_dmaThreadAlignPadding) ==
              REDSOUND_DRIVER_SYNC_DMA_THREAD_PAD_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_DMA_THREAD_PAD_OFFSET == REDSOUND_DRIVER_MAP_BSS_DMA_THREAD_PAD_OFFSET);
...
STATIC_ASSERT(offsetof(RedDriverSyncState, m_MusicSkipThread) == REDSOUND_DRIVER_SYNC_MUSIC_THREAD_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_MUSIC_THREAD_OFFSET == REDSOUND_DRIVER_MAP_BSS_MUSIC_THREAD_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSyncState*)0)->m_MusicSkipThread) == REDSOUND_DRIVER_SYNC_THREAD_SIZE);
STATIC_ASSERT(offsetof(RedDriverSyncState, m_MusicSkipSemaphore) == REDSOUND_DRIVER_SYNC_MUSIC_SEMAPHORE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SYNC_MUSIC_SEMAPHORE_OFFSET ==
              REDSOUND_DRIVER_MAP_BSS_MUSIC_SEMAPHORE_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSyncState*)0)->m_MusicSkipSemaphore) == REDSOUND_DRIVER_SYNC_SEMAPHORE_SIZE);
...
STATIC_ASSERT(sizeof(((RedDriverBssState*)0)->p_SeBlockData) == REDSOUND_SE_BLOCK_DATA_TABLE_SIZE);
STATIC_ASSERT(REDSOUND_DRIVER_BSS_SE_BLOCK_DATA_OFFSET + REDSOUND_SE_BLOCK_DATA_TABLE_SIZE ==
              REDSOUND_DRIVER_BSS_RED_MEMORY_DTOR_CHAIN_OFFSET);
STATIC_ASSERT(offsetof(RedDriverBssState, c_RedMemoryDtorChain) ==
              REDSOUND_DRIVER_BSS_RED_MEMORY_DTOR_CHAIN_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverBssState*)0)->c_RedMemoryDtorChain) == REDSOUND_DRIVER_BSS_DTOR_CHAIN_SIZE);
STATIC_ASSERT(REDSOUND_DRIVER_BSS_RED_MEMORY_DTOR_CHAIN_OFFSET + REDSOUND_DRIVER_BSS_DTOR_CHAIN_SIZE ==
              REDSOUND_DRIVER_BSS_RED_ENTRY_DTOR_CHAIN_OFFSET);
STATIC_ASSERT(offsetof(RedDriverBssState, c_RedEntryDtorChain) ==
              REDSOUND_DRIVER_BSS_RED_ENTRY_DTOR_CHAIN_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverBssState*)0)->c_RedEntryDtorChain) == REDSOUND_DRIVER_BSS_DTOR_CHAIN_SIZE);
STATIC_ASSERT(REDSOUND_DRIVER_BSS_RED_ENTRY_DTOR_CHAIN_OFFSET + REDSOUND_DRIVER_BSS_DTOR_CHAIN_SIZE ==
              REDSOUND_DRIVER_BSS_ENTRY_OFFSET);
STATIC_ASSERT(offsetof(RedDriverBssState, c_RedEntry) == REDSOUND_DRIVER_BSS_ENTRY_OFFSET);
...
#define RedMusicCommandGetId(args) (RedMusicCommandFromArgs(args)->m_musicId)
...
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MASTER_TIME_OFFSET == REDSOUND_DRIVER_MAP_SBSS_MASTER_TIME_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SEQUENCIAL_ID_OFFSET == REDSOUND_DRIVER_MAP_SBSS_SEQUENCIAL_ID_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_THREAD_CONTROL_OFFSET == REDSOUND_DRIVER_MAP_SBSS_THREAD_CONTROL_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_THREAD_EXECUTE_OFFSET == REDSOUND_DRIVER_MAP_SBSS_THREAD_EXECUTE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SOUND_MODE_OFFSET == REDSOUND_DRIVER_MAP_SBSS_SOUND_MODE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_TICK_OFFSET == REDSOUND_DRIVER_MAP_SBSS_TICK_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_ZERO_DATA_OFFSET == REDSOUND_DRIVER_MAP_SBSS_ZERO_DATA_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_EXEC_COMMAND_OFFSET == REDSOUND_DRIVER_MAP_SBSS_EXEC_COMMAND_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_EXEC_COMMAND_NOW_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_EXEC_COMMAND_NOW_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_EXEC_COMMAND_OLD_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_EXEC_COMMAND_OLD_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_DmaControlNow) == REDSOUND_DRIVER_SBSS_DMA_NOW_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_NOW_OFFSET == REDSOUND_DRIVER_MAP_SBSS_DMA_NOW_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSmallDataPrefixState*)0)->p_DmaControlNow) ==
              REDSOUND_DMA_QUEUE_COUNT * sizeof(RedDmaRequest*));
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_NOW_OFFSET +
                  sizeof(((RedDriverSmallDataPrefixState*)0)->p_DmaControlNow) ==
              REDSOUND_DRIVER_SBSS_DMA_OLD_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_OLD_OFFSET == REDSOUND_DRIVER_MAP_SBSS_DMA_OLD_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSmallDataPrefixState*)0)->p_DmaControlOld) ==
              REDSOUND_DMA_QUEUE_COUNT * sizeof(RedDmaRequest*));
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_OLD_OFFSET +
                  sizeof(((RedDriverSmallDataPrefixState*)0)->p_DmaControlOld) ==
              REDSOUND_DRIVER_SBSS_SOUND_CONTROL_BUFFER_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_SoundControlBuffer) ==
              REDSOUND_DRIVER_SBSS_SOUND_CONTROL_BUFFER_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SOUND_CONTROL_BUFFER_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_SOUND_CONTROL_BUFFER_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SOUND_CONTROL_OFFSET == REDSOUND_DRIVER_MAP_SBSS_SOUND_CONTROL_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_KEY_ON_ENTRY_OFFSET == REDSOUND_DRIVER_MAP_SBSS_KEY_ON_ENTRY_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_KEY_ON_DATA_OFFSET == REDSOUND_DRIVER_MAP_SBSS_KEY_ON_DATA_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SOUND_PLAY_MODE_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_SOUND_PLAY_MODE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SOUND_MASTER_CONTROL_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_SOUND_MASTER_CONTROL_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_REPORT_PRINT_OFFSET == REDSOUND_DRIVER_MAP_SBSS_REPORT_PRINT_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_FAST_SPEED_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_FAST_SPEED_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_SKIP_LINE_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_SKIP_LINE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_KEY_SIGNATURE_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_KEY_SIGNATURE_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_MusicReplayPoint) ==
              REDSOUND_DRIVER_SBSS_MUSIC_REPLAY_POINT_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_REPLAY_POINT_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_REPLAY_POINT_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_TEMPO_CONTROL_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_TEMPO_CONTROL_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_PITCH_CONTROL_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_PITCH_CONTROL_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_PHRASE_STOP_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_PHRASE_STOP_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_NEXT_PLAY_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_NEXT_PLAY_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_CROSS_TIME_OFFSET == REDSOUND_DRIVER_MAP_SBSS_CROSS_TIME_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MASTER_MUSIC_VOLUME_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MASTER_MUSIC_VOLUME_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MASTER_SE_VOLUME_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MASTER_SE_VOLUME_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_Stream) == REDSOUND_DRIVER_SBSS_STREAM_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_STREAM_OFFSET == REDSOUND_DRIVER_MAP_SBSS_STREAM_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, m_DMAMode) == REDSOUND_DRIVER_SBSS_DMA_MODE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_MODE_OFFSET == REDSOUND_DRIVER_MAP_SBSS_DMA_MODE_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, m_SeSkipStep) == REDSOUND_DRIVER_SBSS_SE_SKIP_STEP_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SE_SKIP_STEP_OFFSET == REDSOUND_DRIVER_MAP_SBSS_SE_SKIP_STEP_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_VoiceData) == REDSOUND_DRIVER_SBSS_VOICE_DATA_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_VOICE_DATA_OFFSET == REDSOUND_DRIVER_MAP_SBSS_VOICE_DATA_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_EditorVoice) == REDSOUND_DRIVER_SBSS_EDITOR_VOICE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_EDITOR_VOICE_OFFSET == REDSOUND_DRIVER_MAP_SBSS_EDITOR_VOICE_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSmallDataPrefixState*)0)->p_EditorVoice) ==
              REDSOUND_EDITOR_VOICE_COUNT * sizeof(int));
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_EDITOR_VOICE_OFFSET +
                  sizeof(((RedDriverSmallDataPrefixState*)0)->p_EditorVoice) ==
...
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_EDITOR_TRACK_OFFSET == REDSOUND_DRIVER_MAP_SBSS_EDITOR_TRACK_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_MainThreadStack) ==
              REDSOUND_DRIVER_SBSS_MAIN_THREAD_STACK_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MAIN_THREAD_STACK_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MAIN_THREAD_STACK_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, m_MainThreadTime) ==
              REDSOUND_DRIVER_SBSS_MAIN_THREAD_TIME_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MAIN_THREAD_TIME_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MAIN_THREAD_TIME_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_WaveSettingThreadStack) ==
              REDSOUND_DRIVER_SBSS_WAVE_THREAD_STACK_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_WAVE_THREAD_STACK_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_WAVE_THREAD_STACK_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, m_WaveSettingStatus) ==
              REDSOUND_DRIVER_SBSS_WAVE_SETTING_STATUS_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_WAVE_SETTING_STATUS_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_WAVE_SETTING_STATUS_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_DmaExecuteThreadStack) ==
              REDSOUND_DRIVER_SBSS_DMA_THREAD_STACK_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_THREAD_STACK_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_DMA_THREAD_STACK_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, m_DMAStatus) == REDSOUND_DRIVER_SBSS_DMA_STATUS_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_STATUS_OFFSET == REDSOUND_DRIVER_MAP_SBSS_DMA_STATUS_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_MusicSkipThreadStack) ==
              REDSOUND_DRIVER_SBSS_MUSIC_THREAD_STACK_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_THREAD_STACK_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_THREAD_STACK_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, m_MusicSkipComplete) ==
              REDSOUND_DRIVER_SBSS_MUSIC_SKIP_COMPLETE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUSIC_SKIP_COMPLETE_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_MUSIC_SKIP_COMPLETE_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, p_ReverbDepth) == REDSOUND_DRIVER_SBSS_REVERB_DEPTH_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_REVERB_DEPTH_OFFSET == REDSOUND_DRIVER_MAP_SBSS_REVERB_DEPTH_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataPrefixState, m_Mute) == REDSOUND_DRIVER_SBSS_MUTE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUTE_OFFSET == REDSOUND_DRIVER_MAP_SBSS_MUTE_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSmallDataPrefixState*)0)->m_Mute) == REDSOUND_MUTE_WORD_COUNT * sizeof(int));
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_MUTE_OFFSET + sizeof(((RedDriverSmallDataPrefixState*)0)->m_Mute) ==
...
STATIC_ASSERT(offsetof(RedDriverSmallDataTailState, c_RedMemory) == REDSOUND_DRIVER_SBSS_RED_MEMORY_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_RED_MEMORY_OFFSET == REDSOUND_DRIVER_MAP_SBSS_RED_MEMORY_OFFSET);
...
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_EXECUTE_OFFSET == REDSOUND_DRIVER_MAP_SBSS_DMA_EXECUTE_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataTailState, m_DMAInThread) == REDSOUND_DRIVER_SBSS_DMA_IN_THREAD_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_DMA_IN_THREAD_OFFSET == REDSOUND_DRIVER_MAP_SBSS_DMA_IN_THREAD_OFFSET);
STATIC_ASSERT(offsetof(RedDriverSmallDataTailState, m_SilentWave) ==
              REDSOUND_DRIVER_SBSS_SILENT_WAVE_OFFSET);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SILENT_WAVE_OFFSET ==
              REDSOUND_DRIVER_MAP_SBSS_SILENT_WAVE_OFFSET);
STATIC_ASSERT(sizeof(((RedDriverSmallDataTailState*)0)->m_SilentWave) ==
              REDSOUND_DRIVER_SBSS_SILENT_WAVE_SIZE);
STATIC_ASSERT(sizeof(RedDriverSmallDataTailState) == REDSOUND_DRIVER_SBSS_SIZE);
STATIC_ASSERT(REDSOUND_DRIVER_SBSS_SIZE == REDSOUND_DRIVER_MAP_SBSS_SIZE);
...
#define RedMainSemaphoreGet() (&m_MainSemaphore)
...
STATIC_ASSERT(REDSOUND_DRIVER_MAP_RODATA_STRING_OFFSET == 0);
STATIC_ASSERT(REDSOUND_DRIVER_RODATA_SIZE == REDSOUND_DRIVER_MAP_RODATA_STRING_SIZE);
STATIC_ASSERT(sizeof(sRedDriverLogWarnColor) + sizeof(sRedDriverLogReset) == REDSOUND_DRIVER_SDATA2_SIZE);
STATIC_ASSERT(REDSOUND_DRIVER_MAP_SDATA2_STRING_OFFSET == 0);
STATIC_ASSERT(REDSOUND_DRIVER_SDATA2_SIZE == REDSOUND_DRIVER_MAP_SDATA2_STRING_SIZE);
...
static void _MusicPlaySequence(int* command)
{
    ...
    if (c_RedEntry.SearchMusicSequence(RedExecCommandArgGet(command, REDSOUND_MUSIC_COMMAND_ID)) >= 0) {
        replayPoint = RedExecCommandArgGet(command, REDSOUND_MUSIC_COMMAND_MODE);
...
static void _MusicCrossPlaySequence(int* command)
{
    ...
    RedMusicCommandGetFadeTime(command) =
        RedMusicCommandGetFadeTime(command) * REDSOUND_MUSIC_FADE_TICKS_PER_SECOND;
    RedMusicCommandGetFadeTime(command) =
        RedMusicCommandGetFadeTime(command) / REDSOUND_FRAMES_PER_SECOND;
    ...
    if (RedMusicCommandGetId(command) == musicControlBuffer[REDSOUND_CONTROL_MUSIC_SECONDARY].m_musicId) {
        volumeStep = -musicControlBuffer[REDSOUND_CONTROL_MUSIC_PRIMARY].m_masterVolume;
        volumeStep /= RedMusicCommandGetFadeTime(command);
        musicControlBuffer[REDSOUND_CONTROL_MUSIC_PRIMARY].m_masterVolumeAdd = volumeStep;
        musicControlBuffer[REDSOUND_CONTROL_MUSIC_PRIMARY].m_masterVolumeDelta = RedMusicCommandGetFadeTime(command);
        musicControlBuffer = RedSoundControlGet(REDSOUND_CONTROL_MUSIC_SECONDARY);
        volumeStep = REDSOUND_MASTER_VOLUME_FULL_FIXED_HALF;
        volumeStep -= musicControlBuffer->m_masterVolume;
        volumeStep /= RedMusicCommandGetFadeTime(command);
        musicControlBuffer->m_masterVolumeAdd = volumeStep;
        musicControlBuffer->m_masterVolumeDelta = RedMusicCommandGetFadeTime(command);
        musicControlBuffer = (RedSoundCONTROL*)RedNew(REDSOUND_CONTROL_SIZE);
        memcpy(musicControlBuffer, RedSoundControlGet(REDSOUND_CONTROL_MUSIC_SECONDARY), REDSOUND_CONTROL_SIZE);
        ...
        memcpy(RedSoundControlGet(REDSOUND_CONTROL_MUSIC_PRIMARY), musicControlBuffer, REDSOUND_CONTROL_SIZE);
        RedDelete(musicControlBuffer);
    } else {
        if (c_RedEntry.SearchMusicSequence(RedMusicCommandGetId(command)) >= 0) {
            RedCrossTimeSet(RedMusicCommandGetFadeTime(command));
            replayPoint = 0;
            if (musicControlBuffer[REDSOUND_CONTROL_MUSIC_PRIMARY].m_musicId != REDSOUND_MUSIC_ID_NONE) {
                ...
                musicControlBuffer[REDSOUND_CONTROL_MUSIC_PRIMARY].m_masterVolumeAdd = volumeStep;
                musicControlBuffer[REDSOUND_CONTROL_MUSIC_PRIMARY].m_masterVolumeDelta = RedMusicCommandGetFadeTime(command);
                replayPoint = *RedMusicReplayPointGet(RedMusicCommandGetId(command));
                RedMusicReplayPointSet(RedMusicCommandGetId(command), 0);
                if (replayPoint == 0) {
            ...
            MusicPlay(RedMusicCommandGetId(command), RedMusicCommandGetVolume(command), replayPoint);
        }
    }
}
...
static int _MainThread(void*)
{
    ...
    while (RedThreadControlIsRunning()) {
        OSWaitSemaphore(RedMainSemaphoreGet());
...
static int _WaveSettingThread(void* threadArg)
{
    ...
    while (RedThreadControlIsRunning()) {
        OSWaitSemaphore(RedWaveSettingSemaphoreGet());
        if (RedThreadControlIsRunning()) {
            ...
            *waveSetting->m_slot = 0;
            do {
            } while (OSTryWaitSemaphore(RedWaveSettingSemaphoreGet()) > 0);
            RedWaveSettingStatusSet(REDSOUND_WORKER_IDLE);
        }
    }
...
static void _DMACheckProcess()
{
    ...
    if (RedReportPrintIsEnabled()) {
        ...
        OSReport(sRedDriverDmaStatusFmt, sRedDriverLogPrefix, RedDmaStatusGet(),
                 OSGetSemaphoreCount(RedDmaExecuteSemaphoreGet()), RedDmaExecuteGet(), RedDmaThreadStateGet());
        fflush(__files + 1);
    }
                ...
                void* callbackData)
{
    ...
    OSSignalSemaphore(RedDmaExecuteSemaphoreGet());
...
static int _DmaExecuteThread(void*)
{
    ...
    RedDmaThreadStateSet(REDSOUND_DMA_THREAD_IDLE);
    while (RedThreadControlIsRunning()) {
        OSWaitSemaphore(RedDmaExecuteSemaphoreGet());
...
static int _MusicSkipThread(void*)
{
    ...
    while (RedThreadControlIsRunning()) {
        OSWaitSemaphore(RedMusicSkipSemaphoreGet());
        if (RedThreadControlIsRunning()) {
            MusicSkipFunction();
        }
        while (OSTryWaitSemaphore(RedMusicSkipSemaphoreGet()) > 0) {
        }
    }
...
static void _RedAXCallback()
{
    RedMasterTimeInc();
    EnvelopeKeyExecute();
    OSSignalSemaphore(RedMainSemaphoreGet());
}
...
int CRedDriver::SetMusicData(void* musicData)
{
    ...
    if (RedMusicHeadHasValidSignature(header)) {
        memcpy(&localHeader, musicData, REDSOUND_MUSIC_HEADER_SIZE);
        headerSize = RedMusicHeadGetSize(&localHeader);
...
void* CRedDriver::SetSeBlockData(int blockIndex, void* seBlockData)
{
    ...
    if (seBlockData != 0) {
        copySize = RedSeBlockGetSize(RedSeBlockHeadFromData(seBlockData));
        if (copySize > 0) {
...
void CRedDriver::SetWaveData(int slot, int waveID, void* waveData, int waveSize)
{
    ...
    if (waveSize == REDSOUND_WAVE_SIZE_AUTO) {
        ...
        if (RedWaveHeadHasValidSignature(waveHeader)) {
...
void CRedDriver::SetWaveTune(int key, int fineTune)
{
    ...
    editorTrack = RedEditorTrackGet();
    editorTrack->m_keyTranspose = key;
    editorTrack->m_note.m_key = key;
    editorTrack->m_fineTune = fineTune;
    editorTrack->m_portamentPitch = key << REDSOUND_PITCH_BASE_NOTE_SHIFT;
    voiceNo = RedEditorVoiceGetBegin();
    do {
        int voiceIndex = *voiceNo;
...
int CRedDriver::WavePitchCompute(int key, int pitch)
{
    ...
    RedWaveDATA* wave = editorTrack->m_waveData;

    if (wave != 0) {
        if ((wave->m_flags & REDSOUND_WAVE_FLAG_USE_WAVE_KEY) != 0) {
            basePitch = wave->m_splitKey << REDSOUND_PITCH_BASE_NOTE_SHIFT;
        }
        pitchOffset = editorTrack->m_keyTranspose + pitch;
        basePitch += editorTrack->m_pitch;
        return PitchCompute(basePitch, pitchOffset, wave->m_pitch, editorTrack->m_fineTune);
    }
