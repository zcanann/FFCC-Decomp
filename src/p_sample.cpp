...
{
	static const unsigned int s_tableDescData[12] = {
	...
	const unsigned int* desc0 = s_tableDescData;
	const unsigned int* desc1 = s_tableDescData + 3;
	const unsigned int* desc2 = s_tableDescData + 6;
	const unsigned int* desc3 = s_tableDescData + 9;
