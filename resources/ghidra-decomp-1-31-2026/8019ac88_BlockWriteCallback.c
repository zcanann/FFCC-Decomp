...

{
  ...
  iVar3 = param_1 * 0x110;
  if (-1 < param_2) {
    *(int *)(&DAT_803275f8 + iVar3) = *(int *)(&DAT_803275f8 + iVar3) + 0x80;
    *(int *)(&DAT_803275f0 + iVar3) = *(int *)(&DAT_803275f0 + iVar3) + 0x80;
    *(int *)(&DAT_803275f4 + iVar3) = *(int *)(&DAT_803275f4 + iVar3) + 0x80;
    iVar2 = *(int *)(&DAT_803275ec + iVar3);
    *(int *)(&DAT_803275ec + iVar3) = iVar2 + -1;
    if ((0 < iVar2 + -1) && (param_2 = __CARDWritePage(param_1,BlockWriteCallback), -1 < param_2)) {
      return;
    }
  }
