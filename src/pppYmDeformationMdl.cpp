...
extern const float FLOAT_80330D98;
extern const float FLOAT_80330D9C;
extern const float FLOAT_80330DA0;
extern const float FLOAT_80330DA4;
extern const float FLOAT_80330DA8;
...
void pppRenderYmDeformationMdl(pppYmDeformationMdl* pppYmDeformationMdl, pppYmDeformationMdlUnkB* param_2, pppYmDeformationMdlUnkC* param_3)
{
    ...
    if (backTexture != 0) {
        ...
        texMtx[0][0] = texMtx[0][0] * (FLOAT_80330D98 / (float)width);
        texMtx[1][1] = texMtx[1][1] * -(FLOAT_80330D9C / (float)height);
