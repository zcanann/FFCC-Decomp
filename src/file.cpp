...
void CFile::Init()
{
    ...
    void* handlePool = operator new[](0x5610, (CMemory::CStage*)m_allocStage, const_cast<char*>(s_fileCpp), 0x2e);
    m_handlePoolHead.m_currentOffset =
        (u32)__construct_new_array(handlePool, 0, 0, sizeof(CHandle), 0x80);
