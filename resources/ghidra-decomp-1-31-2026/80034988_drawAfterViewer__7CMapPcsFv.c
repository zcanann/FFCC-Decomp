// Function: drawAfterViewer__7CMapPcsFv
// Entry: 80034988
// Size: 540 bytes

void drawAfterViewer__7CMapPcsFv(int param_1)
  ...
  if (*(int *)(param_1 + 0x178) == 0) {
    if (*(int *)(param_1 + 0x180) != 0) {
      ...
      if ((CFlat._4764_4_ & 0x2000000) != 0) {
        ...
        puVar1 = (undefined4 *)__ct__6CColorFUcUcUcUc(auStack_94,0xff,0xff,0x80,0xff);
        local_98 = *puVar1;
        DrawBound__8CGraphicFR6CBound8_GXColor(&Graphic,local_90,&local_98);
      }
    }
  }
  return;
