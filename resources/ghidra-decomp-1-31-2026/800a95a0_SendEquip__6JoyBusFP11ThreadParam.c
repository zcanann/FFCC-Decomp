// Function: SendEquip__6JoyBusFP11ThreadParam
// Entry: 800a95a0
// Size: 704 bytes

/* WARNING: Removing unreachable block (ram,0x800a95d8) */

JoyBus * SendEquip__6JoyBusFP11ThreadParam(JoyBus *joyBus,ThreadParam *threadParam)

{
  ...
  if (threadParam->m_subState == '\x01') {
    ...
    if (threadParam->m_subState == '\0') {
      ...
      local_318 = 6;
      iVar1 = GetEquipData__8GbaQueueFiPUc(&GbaQue,threadParam->m_portIndex,auStack_317);
      pJVar2 = (JoyBus *)
