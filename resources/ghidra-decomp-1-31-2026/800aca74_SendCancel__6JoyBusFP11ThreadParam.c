// Function: SendCancel__6JoyBusFP11ThreadParam
// Entry: 800aca74
// Size: 236 bytes

undefined4 SendCancel__6JoyBusFP11ThreadParam(JoyBus *joyBus,ThreadParam *threadParam)

{
  ...
  if (joyBus->m_threadRunningMask != '\0') {
    ...
    if ((int)joyBus->m_cmdCount[uVar1] < 0x40) {
      joyBus->m_cmdQueueData[uVar1][joyBus->m_cmdCount[uVar1]] = 0x10000000;
