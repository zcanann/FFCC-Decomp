// Function: SendCmd__6JoyBusFP11ThreadParam
// Entry: 800a92e0
// Size: 704 bytes

/* WARNING: Removing unreachable block (ram,0x800a9318) */

JoyBus * SendCmd__6JoyBusFP11ThreadParam(JoyBus *joyBus,ThreadParam *threadParam)

{
  ...
  if (threadParam->m_subState == '\x01') {
    ...
    if (threadParam->m_subState == '\0') {
      ...
      local_318 = 0xc;
      iVar1 = GetCmdData__8GbaQueueFiPUc(&GbaQue,threadParam->m_portIndex,auStack_317);
      pJVar2 = (JoyBus *)
