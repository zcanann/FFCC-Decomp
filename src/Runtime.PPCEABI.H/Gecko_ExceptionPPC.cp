...
public:
	...
	virtual const char* what() const { return s_bad_exception; }
};
...
extern void __unexpected(CatchInfo* catchinfo)
{
	...
	const char* stdExceptionBadExceptionType = unexpectedTypes + sizeof("!bad_exception!!\0\0\0");
	const char* badExceptionType = stdExceptionBadExceptionType - sizeof("!bad_exception!!\0\0\0");
	const char* compareBadExceptionType = stdExceptionBadExceptionType + sizeof("!std::exception!!std::bad_exception!!\0\0");
...
#pragma exception_magic
	...
	try {
		...
		if (ExPPC_IsInSpecification((char*)compareBadExceptionType, unexp)) {
			throw bad_exception();
		}
	}
	terminate();
