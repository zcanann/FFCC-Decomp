...
config.libs = [
    ...
    ]),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "fontman.cpp", mw_version="GC/2.5", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly", "-inline auto,deferred"]),
            Object(NonMatching, "FS_USB_Process.cpp", cflags=cflags_game_cpp_exceptions),
            Object(NonMatching, "FunnyShape.cpp"),
            Object(NonMatching, "game.cpp", mw_version="GC/2.5", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly", "-inline noauto,deferred"]),
            ...
            Object(NonMatching, "map.cpp", mw_version="GC/2.5", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly"]),
            ...
            Object(NonMatching, "materialman.cpp", mw_version="GC/2.5", extra_cflags=["-RTTI on", "-sdata 8", "-inline auto,deferred", "-str reuse,nopool,readonly"]),
            ...
            Object(NonMatching, "menu_letter.cpp", extra_cflags=["-inline auto,deferred"]),
            Object(NonMatching, "menu_lst.cpp"),
            Object(NonMatching, "menu_money.cpp"),
            Object(NonMatching, "menu_tmparti.cpp"),
            Object(NonMatching, "MenuUtil.cpp", extra_cflags=["-O3,p", "-sdata2 16", "-char unsigned"]),
            ...
            Object(NonMatching, "p_FunnyShape.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly", "-inline noauto,deferred"]),
            Object(Matching, "p_game.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
            Object(Matching, "p_gba.cpp", cflags=[*cflags_game_cpp_exceptions, "-RTTI on", "-sdata 8", "-str reuse,readonly", "-inline auto,deferred"]),
            Object(NonMatching, "p_graphic.cpp", cflags=[*cflags_game_cpp_exceptions, "-RTTI on", "-sdata 8", "-str reuse,pool,readonly", "-pooldata off"]),
            Object(NonMatching, "p_light.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-inline auto,deferred", "-str reuse,pool,readonly"]),
            Object(NonMatching, "p_map.cpp", extra_cflags=["-pooldata off", "-RTTI on", "-sdata 8", "-inline auto,deferred", "-str reuse,pool,readonly"]),
            Object(NonMatching, "p_MaterialEditor.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
            Object(Matching, "p_mc.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
            Object(NonMatching, "p_menu.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,pool,readonly", "-inline auto,deferred"]),
            Object(NonMatching, "p_minigame.cpp", extra_cflags=["-inline auto,deferred", "-RTTI on", "-sdata 8", "-common off", "-str reuse,pool,readonly"]),
            Object(Matching, "p_sample.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
            Object(Matching, "p_sound.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
            Object(Matching, "p_system.cpp", extra_cflags=["-RTTI on", "-sdata 8", "-str reuse,readonly"]),
            ...
            Object(NonMatching, "pppCharaBreak.cpp", mw_version="GC/2.0"),
            ...
            Object(NonMatching, "pppLaser.cpp", extra_cflags=["-inline auto,deferred", "-str reuse,pool,readonly"]),
            ...
            Object(Matching, "pppPointRAp.cpp"),
            ...
            Object(Matching, "pppSRandDownFV.cpp"),
            Object(Matching, "pppSRandDownHCV.cpp"),
            Object(Matching, "pppSRandFV.cpp"),
            Object(Matching, "pppSRandHCV.cpp"),
            Object(Matching, "pppSRandUpCV.cpp"),
            Object(Matching, "pppSRandUpFV.cpp"),
            ...
            Object(NonMatching, "prgobj.cpp", extra_cflags=["-RTTI on", "-str reuse,pool,readonly", "-inline auto,deferred"]),
