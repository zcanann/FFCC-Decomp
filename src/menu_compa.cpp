...
void CMenuPcs::CompaInit()
{
	...
	CompaOpenAnimList* compaList = this->compaList;
	compaList->entries[0].tex = 0x52;
	compaList->entries[0].drawFlags = 4;
	compaList->entries[0].x = 0x28;
	compaList->entries[0].y = 0x30;
	compaList->entries[0].w = 0x198;
	compaList->entries[0].h = 0x18;
	compaList->entries[0].u = FLOAT_80332FF8;
	compaList->entries[0].v = FLOAT_80332FF8;
	compaList->entries[0].uvScale = FLOAT_80333000;
	compaList->entries[0].startFrame = 5;
	compaList->entries[0].duration = 5;

	compaList = this->compaList;
	compaList->entries[1].tex = 0x51;
	compaList->entries[1].x = 0x28;
	compaList->entries[1].y = 0x48;
	compaList->entries[1].w = 0x198;
	compaList->entries[1].h = 200;
	compaList->entries[1].u = FLOAT_80332FF8;
	compaList->entries[1].v = FLOAT_80332FF8;
	compaList->entries[1].uvScale = FLOAT_80333000;
	compaList->entries[1].startFrame = 5;
	compaList->entries[1].duration = 5;

	compaList = this->compaList;
	compaList->entries[2].tex = 0x52;
	compaList->entries[2].x = 0x28;
	compaList->entries[2].y = 0x110;
	compaList->entries[2].w = 0x198;
	compaList->entries[2].h = 0x18;
	compaList->entries[2].u = FLOAT_80332FF8;
	compaList->entries[2].v = FLOAT_80332FF8;
	compaList->entries[2].uvScale = FLOAT_80333000;
	compaList->entries[2].startFrame = 5;
	compaList->entries[2].duration = 5;

	compaList = this->compaList;
	compaList->entries[3].tex = 0x5e;
	compaList->entries[3].x = 0x10;
	compaList->entries[3].y = 0xe;
	compaList->entries[3].w = 0x30;
	compaList->entries[3].h = 0x30;
	compaList->entries[3].u = FLOAT_80332FF8;
	compaList->entries[3].v = FLOAT_80332FF8;
	compaList->entries[3].uvScale = FLOAT_80333000;
	compaList->entries[3].startFrame = 0;
	compaList->entries[3].duration = 5;

	compaList = this->compaList;
	compaList->entries[4].tex = 0x5e;
	compaList->entries[4].x = 0x15;
	compaList->entries[4].w = 0x30;
	compaList->entries[4].h = 0x30;
	compaList->entries[4].y = static_cast<short>(0x150 - compaList->entries[4].h);
	compaList->entries[4].u = FLOAT_80332FF8;
	compaList->entries[4].v = FLOAT_80332FF8;
	compaList->entries[4].uvScale = FLOAT_80333038;
	compaList->entries[4].startFrame = 0;
	compaList->entries[4].duration = 5;

	compaList = this->compaList;
	compaList->entries[5].flags = 2;
	compaList->entries[5].drawFlags = 0x2e;
	compaList->entries[5].x = 0x10;
	compaList->entries[5].y = 8;
	compaList->entries[5].w = 0x30;
	compaList->entries[5].h = 0x140;
	compaList->entries[5].u = FLOAT_8033303C;
	compaList->entries[5].v = FLOAT_80332FF8;
	compaList->entries[5].startFrame = 0;
