...
enum RedStreamHeadLayoutOffset {
    ...
    REDSOUND_STREAM_HEAD_RESERVED18_OFFSET = 0x18,
    REDSOUND_STREAM_HEAD_CHANNEL_COUNT_OFFSET = 0x1A,
...
enum RedStreamAdpcmHeaderLayoutOffset {
    REDSOUND_STREAM_ADPCM_DATA_OFFSET = 0x00,
    REDSOUND_STREAM_ADPCM_LOOP_OFFSET = 0x28,
...
enum RedStreamFileLayoutOffset {
    ...
    REDSOUND_STREAM_FILE_ADPCM_END = REDSOUND_STREAM_FILE_ADPCM_OFFSET + REDSOUND_STREAM_ADPCM_HEADER_SIZE,
    REDSOUND_STREAM_FILE_TRAILING_PAD_OFFSET = REDSOUND_STREAM_FILE_ADPCM_END,
    REDSOUND_STREAM_FILE_TRAILING_PAD_SIZE = 0x02,
    REDSOUND_STREAM_FILE_SIZE = REDSOUND_STREAM_FILE_ADPCM_END + REDSOUND_STREAM_FILE_TRAILING_PAD_SIZE,
};
...
enum RedStreamDataLayoutOffset {
    ...
    REDSOUND_STREAM_VOLUME_STEP_OFFSET = 0xF4,
    REDSOUND_STREAM_VOLUME_STEP_COUNT_OFFSET = 0xF8,
    REDSOUND_STREAM_RESERVED_FC_OFFSET = 0xFC,
    REDSOUND_STREAM_PAN_OFFSET = 0x100,
    REDSOUND_STREAM_PAN_STEP_OFFSET = 0x104,
    REDSOUND_STREAM_PAN_STEP_COUNT_OFFSET = 0x108,
    ...
    REDSOUND_STREAM_FILE_CURSOR_OFFSET = 0x11C,
