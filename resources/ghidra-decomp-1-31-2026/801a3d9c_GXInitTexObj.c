...
void GXInitTexObj(uint *param_1,uint param_2,uint param_3,uint param_4,uint param_5,uint param_6,
  ...
  *param_1 = *param_1 & 0xffffffef | 0x10;
  if (param_8 == '\0') {
    ...
    *(byte *)((int)param_1 + 0x1f) = *(byte *)((int)param_1 + 0x1f) | 1;
    ...
    param_1[1] = ((int)(FLOAT_803338a8 *
                       (float)((double)CONCAT44(0x43300000,0x1f - iVar1) - DOUBLE_803338b0)) & 0xffU
