...
static const float kCharaViewerGridMin = 100.0f;
static const char kCharaViewerNoName[] = "no name";
static const double kCharaViewerColorWhiteBias = 4503599627370496.0;
static const char kCharaViewerSpinner[] = "|/-\\";
static const char kCharaViewerChoiceFmt[] = "[%c] %s";
static const float kCharaViewerFineStep = -1.0f;
static const float kCharaViewerLerpScale = 0.25f;
...
static const float kCharaViewerLightPosX = -533.0f;
static const float kCharaViewerLightPosY = -131.0f;
static const float kCharaViewerLightPosZ = -117.0f;
static const float kCharaViewerLightTargetX = 4391.0f;
static const float kCharaViewerLightTargetY = -1864.0f;
static const float kCharaViewerLightTargetZ = 7194.0f;
static const char kCharaViewerCRefName[] = "CRef";
