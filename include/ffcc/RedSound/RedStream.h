...
enum RedStreamHeadLayoutOffset {
    REDSOUND_STREAM_HEAD_SIGNATURE_OFFSET = 0,
    REDSOUND_STREAM_HEAD_RESERVED04_OFFSET = REDSOUND_STREAM_HEAD_SIGNATURE_OFFSET + REDSOUND_STREAM_SIGNATURE_SIZE,
    REDSOUND_STREAM_HEAD_LOOP_END_OFFSET = REDSOUND_STREAM_HEAD_RESERVED04_OFFSET + REDSOUND_STREAM_HEAD_RESERVED04_SIZE,
    REDSOUND_STREAM_HEAD_LOOP_START_OFFSET = REDSOUND_STREAM_HEAD_LOOP_END_OFFSET + sizeof(int),
    REDSOUND_STREAM_HEAD_PITCH_OFFSET = REDSOUND_STREAM_HEAD_LOOP_START_OFFSET + sizeof(int),
    REDSOUND_STREAM_HEAD_RESERVED18_OFFSET = REDSOUND_STREAM_HEAD_PITCH_OFFSET + sizeof(int),
    REDSOUND_STREAM_HEAD_CHANNEL_COUNT_OFFSET =
        REDSOUND_STREAM_HEAD_RESERVED18_OFFSET + REDSOUND_STREAM_HEAD_RESERVED18_SIZE,
    REDSOUND_STREAM_HEAD_FLAGS_OFFSET = REDSOUND_STREAM_HEAD_CHANNEL_COUNT_OFFSET + sizeof(s16),
    REDSOUND_STREAM_HEAD_RESERVED1E_OFFSET = REDSOUND_STREAM_HEAD_FLAGS_OFFSET + sizeof(s16),
    REDSOUND_STREAM_HEAD_SIZE = REDSOUND_STREAM_HEAD_RESERVED1E_OFFSET + REDSOUND_STREAM_HEAD_RESERVED1E_SIZE,
};
...
enum RedStreamAdpcmHeaderLayoutOffset {
    REDSOUND_STREAM_ADPCM_DATA_OFFSET = 0,
    REDSOUND_STREAM_ADPCM_LOOP_OFFSET = REDSOUND_STREAM_ADPCM_DATA_OFFSET + sizeof(AXPBADPCM),
...
enum RedStreamFrameLayoutSize {
    REDSOUND_STREAM_STEREO_LEFT_FRAME_OFFSET = 0,
...
enum RedStreamStepDataLayoutOffset {
    REDSOUND_STREAM_STEP_VALUE_OFFSET = 0,
    REDSOUND_STREAM_STEP_STEP_OFFSET = REDSOUND_STREAM_STEP_VALUE_OFFSET + sizeof(int),
    REDSOUND_STREAM_STEP_COUNT_OFFSET = REDSOUND_STREAM_STEP_STEP_OFFSET + sizeof(int),
};
...
enum RedStreamDataLayoutOffset {
    REDSOUND_STREAM_TRACK_OFFSET = 0,
    REDSOUND_STREAM_VOICE_DATA_OFFSET = REDSOUND_STREAM_TRACK_OFFSET + sizeof(RedTrackDATA*),
    REDSOUND_STREAM_FILE_DATA_OFFSET = REDSOUND_STREAM_VOICE_DATA_OFFSET + sizeof(RedVoiceDATA*),
    REDSOUND_STREAM_BUFFER_OFFSET = REDSOUND_STREAM_FILE_DATA_OFFSET + sizeof(u8*),
    REDSOUND_STREAM_HEADER_OFFSET = REDSOUND_STREAM_BUFFER_OFFSET + sizeof(u8*),
    REDSOUND_STREAM_TRACK_DATA_OFFSET = REDSOUND_STREAM_HEADER_OFFSET + REDSOUND_STREAM_HEAD_SIZE,
    REDSOUND_STREAM_VOLUME_OFFSET =
        REDSOUND_STREAM_TRACK_DATA_OFFSET + sizeof(RedWaveDATA) * REDSOUND_STREAM_TRACK_DATA_COUNT,
    REDSOUND_STREAM_VOLUME_STEP_OFFSET = REDSOUND_STREAM_VOLUME_OFFSET + sizeof(int),
    REDSOUND_STREAM_VOLUME_STEP_COUNT_OFFSET = REDSOUND_STREAM_VOLUME_STEP_OFFSET + sizeof(int),
    REDSOUND_STREAM_RESERVED_FC_OFFSET = REDSOUND_STREAM_VOLUME_STEP_COUNT_OFFSET + sizeof(int),
    REDSOUND_STREAM_PAN_OFFSET = REDSOUND_STREAM_RESERVED_FC_OFFSET + sizeof(int),
    REDSOUND_STREAM_PAN_STEP_OFFSET = REDSOUND_STREAM_PAN_OFFSET + sizeof(int),
    REDSOUND_STREAM_PAN_STEP_COUNT_OFFSET = REDSOUND_STREAM_PAN_STEP_OFFSET + sizeof(int),
    REDSOUND_STREAM_ID_OFFSET = REDSOUND_STREAM_PAN_STEP_COUNT_OFFSET + sizeof(int),
    REDSOUND_STREAM_STATE_OFFSET = REDSOUND_STREAM_ID_OFFSET + sizeof(int),
    REDSOUND_STREAM_DMA_ID_OFFSET = REDSOUND_STREAM_STATE_OFFSET + sizeof(int),
    REDSOUND_STREAM_FILE_SIZE_OFFSET = REDSOUND_STREAM_DMA_ID_OFFSET + sizeof(int),
    REDSOUND_STREAM_FILE_CURSOR_OFFSET = REDSOUND_STREAM_FILE_SIZE_OFFSET + sizeof(int),
    REDSOUND_STREAM_READ_OFFSET = REDSOUND_STREAM_FILE_CURSOR_OFFSET + sizeof(int),
    REDSOUND_STREAM_CURSOR_OFFSET = REDSOUND_STREAM_READ_OFFSET + sizeof(int),
    REDSOUND_STREAM_CURSOR_BASE_OFFSET = REDSOUND_STREAM_CURSOR_OFFSET + sizeof(int),
    REDSOUND_STREAM_ARAM_BUFFER_OFFSET = REDSOUND_STREAM_CURSOR_BASE_OFFSET + sizeof(int),
};
