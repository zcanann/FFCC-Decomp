...
enum RedSoundLocalSize {
	...
	REDSOUND_DRIVER_DTOR_CHAIN_SIZE = sizeof(DestructorChain),
	REDSOUND_STANDBY_STATUS_COUNT = 0x40,
	REDSOUND_STANDBY_STATUS_SIZE = REDSOUND_STANDBY_STATUS_COUNT * sizeof(int),
	REDSOUND_STANDBY_STATUS_OFFSET = REDSOUND_DRIVER_DTOR_CHAIN_SIZE,
...
enum RedSoundMapLayout {
	REDSOUND_MAP_BSS_DRIVER_DTOR_CHAIN_OFFSET = 0x00,
	REDSOUND_MAP_BSS_STANDBY_STATUS_OFFSET = 0x0C,
	REDSOUND_MAP_BSS_SIZE = 0x10C,
	REDSOUND_MAP_RODATA_STRING_OFFSET = 0x00,
	REDSOUND_MAP_RODATA_STRING_SIZE = 0x128,
	REDSOUND_MAP_SBSS_DRIVER_OFFSET = 0x00,
	REDSOUND_MAP_SBSS_AUTO_ID_OFFSET = 0x04,
	REDSOUND_MAP_SBSS_STREAM_BANK_OFFSET = 0x08,
	REDSOUND_MAP_SBSS_SIZE = 0x0C,
	REDSOUND_MAP_SDATA2_STRING_OFFSET = 0x00,
	REDSOUND_MAP_SDATA2_STRING_SIZE = 0x15,
};
...
struct RedSoundBssState {
	DestructorChain c_DriverDtorChain;
...
STATIC_ASSERT(REDSOUND_STANDBY_STATUS_OFFSET == REDSOUND_MAP_BSS_STANDBY_STATUS_OFFSET);
STATIC_ASSERT(sizeof(RedSoundBssState) == REDSOUND_BSS_SIZE);
STATIC_ASSERT(REDSOUND_BSS_SIZE == REDSOUND_MAP_BSS_SIZE);
STATIC_ASSERT(REDSOUND_DRIVER_DTOR_CHAIN_SIZE + REDSOUND_STANDBY_STATUS_SIZE == REDSOUND_BSS_SIZE);
...
STATIC_ASSERT(REDSOUND_SOUND_SBSS_DRIVER_OFFSET == 0);
STATIC_ASSERT(REDSOUND_SOUND_SBSS_DRIVER_OFFSET == REDSOUND_MAP_SBSS_DRIVER_OFFSET);
STATIC_ASSERT(REDSOUND_SOUND_SBSS_DRIVER_OFFSET + REDSOUND_DRIVER_OBJECT_SIZE + REDSOUND_SBSS_PADDING_SIZE ==
              REDSOUND_SOUND_SBSS_AUTO_ID_OFFSET);
STATIC_ASSERT(offsetof(RedSoundSmallDataState, m_AutoID) == REDSOUND_SOUND_SBSS_AUTO_ID_OFFSET);
STATIC_ASSERT(REDSOUND_SOUND_SBSS_AUTO_ID_OFFSET == REDSOUND_MAP_SBSS_AUTO_ID_OFFSET);
STATIC_ASSERT(REDSOUND_SOUND_SBSS_AUTO_ID_OFFSET + REDSOUND_AUTO_ID_SIZE == REDSOUND_SOUND_SBSS_STREAM_BANK_OFFSET);
STATIC_ASSERT(offsetof(RedSoundSmallDataState, p_StreamBank) == REDSOUND_SOUND_SBSS_STREAM_BANK_OFFSET);
STATIC_ASSERT(REDSOUND_SOUND_SBSS_STREAM_BANK_OFFSET == REDSOUND_MAP_SBSS_STREAM_BANK_OFFSET);
STATIC_ASSERT(sizeof(RedSoundSmallDataState) == REDSOUND_SBSS_SIZE);
STATIC_ASSERT(REDSOUND_SBSS_SIZE == REDSOUND_MAP_SBSS_SIZE);
STATIC_ASSERT(sizeof(c_Driver) + REDSOUND_SBSS_PADDING_SIZE + sizeof(m_AutoID) + sizeof(p_StreamBank) ==
              REDSOUND_SBSS_SIZE);
STATIC_ASSERT(REDSOUND_MAP_RODATA_STRING_OFFSET == 0);
...
STATIC_ASSERT(REDSOUND_RODATA_STRING_SIZE == REDSOUND_MAP_RODATA_STRING_SIZE);
STATIC_ASSERT(REDSOUND_MAP_SDATA2_STRING_OFFSET == 0);
...
STATIC_ASSERT(REDSOUND_SDATA2_STRING_SIZE == REDSOUND_MAP_SDATA2_STRING_SIZE);
