...
STATIC_ASSERT(offsetof(pppYmLaserMapCylinder, m_axis) == offsetof(CMapCylinder, m_axis));
STATIC_ASSERT(offsetof(pppYmLaserMapCylinder, m_boundsMin) == offsetof(CMapCylinder, m_boundsMin));
STATIC_ASSERT(offsetof(pppYmLaserMapCylinder, m_boundsMax) == offsetof(CMapCylinder, m_boundsMax));
