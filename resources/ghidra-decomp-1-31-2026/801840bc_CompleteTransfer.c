...

{
  ...
  if (DAT_80217304 != -1) {
    ...
    uVar3 = 0;
    *(undefined8 *)(&DAT_8030c890 + DAT_80217304 * 8) = uVar10;
    uVar5 = DAT_8021730c >> 2;
    puVar4 = DAT_80217310;
    if (uVar5 != 0) {
    ...
    if ((uVar5 & 0x20000000) == 0) {
      uVar10 = __OSGetSystemTime();
      uVar6 = 0;
      *(undefined8 *)(&DAT_8030c870 + DAT_80217304 * 8) = uVar10;
    }
    else {
      uVar5 = uVar6 >> (3 - DAT_80217304) * 8;
      uVar6 = uVar5 & 0xf;
      if (((uVar5 & 8) != 0) && ((*(uint *)(&DAT_80217318 + DAT_80217304 * 4) & 0x80) == 0)) {
        *(uint *)(&DAT_80217318 + DAT_80217304 * 4) = 8;
      }
      if (uVar6 == 0) {
        uVar6 = 4;
      }
