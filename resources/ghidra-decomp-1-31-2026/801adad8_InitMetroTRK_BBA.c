...
undefined8
InitMetroTRK_BBA(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  DAT_8032a248 = in_LR;
  DAT_8032a24c = in_LR;
  TRKSaveExtended1Block(in_MSR | 0x8000);
  iVar1 = InitMetroTRKCommTable
                    (2,DAT_8032a1d8,DAT_8032a1dc,DAT_8032a1e0,DAT_8032a1e4,DAT_8032a1e8,DAT_8032a1ec
                     ,DAT_8032a1f0);
  if (iVar1 == 1) {
    return uRam0000000d;
  }
