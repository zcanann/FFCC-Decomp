...
extern "C" void pppConstructYmLaser(pppYmLaser* laser, _pppCtrlTable* ctrlTable)
{
	...
	*work = FLOAT_80330dc0;
	...
	work[5] = FLOAT_80330dc0;
	work[4] = FLOAT_80330dc0;
	work[3] = FLOAT_80330dc0;
	work[2] = FLOAT_80330dc0;
	work[1] = FLOAT_80330dc0;
	*(u32*)((u8*)work + 0x1c) = 0;
	work[10] = FLOAT_80330dc0;
	work[9] = FLOAT_80330dc0;
	work[8] = FLOAT_80330dc0;
	*((u8*)work + 0x2c) = 0;
	*((u8*)work + 0x2d) = 0;
	*((u8*)work + 0x2e) = 0;
	*((u16*)((u8*)work + 0x30)) = 0;
