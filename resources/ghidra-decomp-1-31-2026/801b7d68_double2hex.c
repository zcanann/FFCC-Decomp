...

{
  ...
  if (*(int *)(param_3 + 0xc) < 0x1fe) {
    ...
    local_78 = param_1;
    local_68 = param_1;
    __num2dec(local_70,auStack_40);
    if (local_3b == 'I') {
      if (((int)local_68._0_2_ & 0x8000U) == 0) {
        pcVar2 = (char *)(param_2 + -4);
        if (*(char *)(param_3 + 5) == 'A') {
          strcpy(pcVar2,&DAT_801e70c3);
        }
        else {
          strcpy(pcVar2,&DAT_801e70c7);
        }
      }
      else {
        pcVar2 = (char *)(param_2 + -5);
        if (*(char *)(param_3 + 5) == 'A') {
          strcpy(pcVar2,&DAT_801e70b9);
        }
        else {
          strcpy(pcVar2,&DAT_801e70be);
        }
      }
    }
    else if (local_3b == 'N') {
      if ((local_78 & 0x8000000000000000) == 0) {
        pcVar2 = (char *)(param_2 + -4);
        if (*(char *)(param_3 + 5) == 'A') {
          strcpy(pcVar2,&DAT_801e70d5);
        }
        else {
          strcpy(pcVar2,&DAT_801e70d9);
        }
      }
      else {
        pcVar2 = (char *)(param_2 + -5);
        if (*(char *)(param_3 + 5) == 'A') {
          strcpy(pcVar2,&DAT_801e70cb);
        }
        else {
          strcpy(pcVar2,&DAT_801e70d0);
        }
      }
    }
    else {
      ...
      local_58 = 0;
      local_54 = 1;
      iVar3 = long2str((short)((ushort)((uint)(int)local_68._0_2_ >> 4) & 0x7ff) + -0x3ff,param_2,
                       &local_60);
      if (*(char *)(param_3 + 5) == 'a') {
